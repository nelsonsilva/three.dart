...
$$._HashMapImpl = {"": "Object;_keys>,_values>,_loadLimit,_numberOfEntries,_numberOfDeleted",
  ...
  $$index$bailout3: function(state0, index) {
    var t1;
    if ($.$$lt(index, 0) === true)
      return;
    t1 = this._values;
...
$$.Canvas_Lines = {"": "Object;container,camera,scene,renderer,material=,geometry>,mouseX,mouseY,windowHalfX,windowHalfY",
  init$0: function() {
    var rnd, i, particle, t1, t2, line;
    this.windowHalfX = $.$$tdiv(window.get$innerWidth(), 2);
    this.windowHalfY = $.$$tdiv(window.get$innerHeight(), 2);
    ...
    this.material = $.ParticleCanvasMaterial$(0, 205, 100, 204, 1, 16777215, true, true, "", 1, false, false, 0, 0, new $.Canvas_Lines_init_anon(6.283185307179586), 0, false, true);
    this.geometry = $.Geometry$();
    rnd = $.Random_Random(null);
    for (i = 0; i < 100; ++i) {
      particle = $.Particle$(this.material);
      t1 = $.$$sub($.$$mul(rnd.nextDouble$0(), 2), 1);
      t2 = particle.position;
      t2.x = t1;
      t2.y = $.$$sub($.$$mul(rnd.nextDouble$0(), 2), 1);
      t2.z = $.$$sub($.$$mul(rnd.nextDouble$0(), 2), 1);
      t2.normalize$0();
      t2.multiplyScalar$1($.$$add($.$$mul(rnd.nextDouble$0(), 10), 450));
      t1 = particle.scale;
      t1.y = 5;
      t1.x = 5;
      $.add(this.scene, particle);
      $.add(this.geometry.get$vertices(), t2);
    }
    line = $.Line$(this.geometry, $.LineBasicMaterial$(0, 205, 100, 204, 1, 16777215, true, true, true, "round", "round", 1, "", 0.5, false, false, 0, 0, 0, false, 0, true), 0);
    $.add(this.scene, line);
    $.add(document.get$on().get$mouseMove(), this.get$onDocumentMouseMove());
    $.add(document.get$on().get$touchStart(), this.get$onDocumentTouchStart());
    $.add(document.get$on().get$touchMove(), this.get$onDocumentTouchMove());
    window.setInterval$2(new $.Canvas_Lines_init_anon0(this), 10);
  },
  ...
  onDocumentTouchStart$1: function(event) {
    if ($.$$gt($.length(event.get$touches()), 1) === true) {
  ...
  render$0: function() {
    ...
    t1.set$y($.$$add(t1.get$y(), $.$$mul($.$$sub($.$$add($.$$negate(this.mouseY), 200), this.camera.get$position().get$y()), 0.05)));
...
$$.PerspectiveCamera = {"": "Camera;fov,aspect,_fullWidth,_fullHeight,_x,_y,_width,_height,matrixWorldInverse,projectionMatrix,projectionMatrixInverse,near,far,id,name,properties,parent,children,up,position,rotation,scale,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth,matrix,matrixWorld,matrixRotationWorld,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible,castShadow,receiveShadow,frustumCulled,_vector,__data",
  updateProjectionMatrix$0: function() {
    ...
    if (!(t1 == null)) {
      ...
      t11 = t10.$add(left, $.$$div($.CONSTANT2.$mul(t9, t8), t1));
      t10 = t10.$add(left, $.$$div($.$$mul($.CONSTANT2.$add(t9, t8), t8), t1));
      t12 = this._y;
      t13 = $.$$div($.$$mul($.CONSTANT2.$add(t12, height), height), t6);
      if (typeof t13 !== "number")
        throw $.iae(t13);
      t6 = $.$$div($.CONSTANT2.$mul(t12, height), t6);
      if (typeof t6 !== "number")
        throw $.iae(t6);
...
$$.Vector3 = {"": "Object;x=,y=,z=",
  ...
  multiplyScalar$1: function(s) {
    ...
    t3 = this.y;
    if (typeof t3 !== "number")
      return this.multiplyScalar$1$bailout(3, s, null, t3);
    this.y = t3 * s;
    t5 = this.z;
    if (typeof t5 !== "number")
      return this.multiplyScalar$1$bailout(4, s, null, null, t5);
    this.z = t5 * s;
    return this;
  },
  multiplyScalar$1$bailout: function(state0, s, t1, t3, t5) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
  ...
  normalize$0: function() {
    ...
    t5 = this.z;
    if (typeof t5 !== "number")
      return this.normalize$0$bailout(3, t1, null, t5);
    return this.divideScalar$1(Math.sqrt($.checkNum(t1 + t5 * t5)));
  },
  normalize$0$bailout: function(state0, t1, t3, t5) {
    switch (state0) {
      case 0:
        t1 = this.x;
      case 1:
...
$$.Matrix4 = {"": "Object;elements=",
  ...
  lookAt$3: function(eye, center, up) {
    ...
    if ($.$$eq($.length1(z), 0) === true)
      z.set$z(1);
    x.cross$2(up, z).normalize$0();
    if ($.$$eq($.length1(x), 0) === true) {
  ...
  multiplyScalar$1: function(s) {
    ...
    if (typeof te !== "object" || te === null || (te.constructor !== Array || !!te.immutable$list) && !te.$isJavaScriptIndexingBehavior())
      return this.multiplyScalar$1$bailout1(2, s, te);
    t2 = te.length;
    if (0 >= t2)
      throw $.ioore(0);
    t3 = te[0];
    if (typeof t3 !== "number")
      return this.multiplyScalar$1$bailout1(3, s, te, $.CONSTANT1, t3);
    te[0] = t3 * s;
    if (4 >= t2)
      throw $.ioore(4);
    t5 = te[4];
    if (typeof t5 !== "number")
      return this.multiplyScalar$1$bailout1(4, s, te, $.CONSTANT1, null, t5);
    te[4] = t5 * s;
    if (8 >= t2)
      throw $.ioore(8);
    t7 = te[8];
    if (typeof t7 !== "number")
      return this.multiplyScalar$1$bailout1(5, s, te, $.CONSTANT1, null, null, t7);
    te[8] = t7 * s;
    if (12 >= t2)
      throw $.ioore(12);
    t9 = te[12];
    if (typeof t9 !== "number")
      return this.multiplyScalar$1$bailout1(6, s, te, $.CONSTANT1, null, null, null, t9);
    te[12] = t9 * s;
    t11 = te[1];
    if (typeof t11 !== "number")
      return this.multiplyScalar$1$bailout1(7, s, te, $.CONSTANT1, null, null, null, null, t11);
    te[1] = t11 * s;
    t13 = te[5];
    if (typeof t13 !== "number")
      return this.multiplyScalar$1$bailout1(8, s, te, $.CONSTANT1, null, null, null, null, null, t13);
    te[5] = t13 * s;
    t15 = te[9];
    if (typeof t15 !== "number")
      return this.multiplyScalar$1$bailout1(9, s, te, $.CONSTANT1, null, null, null, null, null, null, t15);
    te[9] = t15 * s;
    if (13 >= t2)
      throw $.ioore(13);
    t17 = te[13];
    if (typeof t17 !== "number")
      return this.multiplyScalar$1$bailout1(10, s, te, $.CONSTANT1, null, null, null, null, null, null, null, t17);
    te[13] = t17 * s;
    t19 = te[2];
    if (typeof t19 !== "number")
      return this.multiplyScalar$1$bailout1(11, s, te, $.CONSTANT1, null, null, null, null, null, null, null, null, t19);
    te[2] = t19 * s;
    t21 = te[6];
    if (typeof t21 !== "number")
      return this.multiplyScalar$1$bailout1(12, s, te, $.CONSTANT1, null, null, null, null, null, null, null, null, null, t21);
    te[6] = t21 * s;
    t23 = te[10];
    if (typeof t23 !== "number")
      return this.multiplyScalar$1$bailout1(13, s, te, $.CONSTANT1, null, null, null, null, null, null, null, null, null, null, t23);
    te[10] = t23 * s;
    if (14 >= t2)
      throw $.ioore(14);
    t25 = te[14];
    if (typeof t25 !== "number")
      return this.multiplyScalar$1$bailout1(14, s, te, $.CONSTANT1, null, null, null, null, null, null, null, null, null, null, null, t25);
    te[14] = t25 * s;
    t27 = te[3];
    if (typeof t27 !== "number")
      return this.multiplyScalar$1$bailout1(15, s, te, $.CONSTANT1, null, null, null, null, null, null, null, null, null, null, null, null, t27);
    te[3] = t27 * s;
    t29 = te[7];
    if (typeof t29 !== "number")
      return this.multiplyScalar$1$bailout1(16, s, te, $.CONSTANT1, null, null, null, null, null, null, null, null, null, null, null, null, null, t29);
    te[7] = t29 * s;
    t31 = te[11];
    if (typeof t31 !== "number")
      return this.multiplyScalar$1$bailout1(17, s, te, $.CONSTANT1, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t31);
    te[11] = t31 * s;
    if (15 >= t2)
      throw $.ioore(15);
    t33 = te[15];
    if (typeof t33 !== "number")
      return this.multiplyScalar$1$bailout1(18, s, te, $.CONSTANT1, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t33);
    te[15] = t33 * s;
    return this;
  },
  multiplyScalar$1$bailout1: function(state0, s, te, t2, t3, t5, t7, t9, t11, t13, t15, t17, t19, t21, t23, t25, t27, t29, t31, t33) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
  ...
  extractRotation$1: function(m) {
    ...
    t1 = $.getInterceptor$JSStringJSArray(me);
    t2 = $.length1(vector.setValues$3(t1.$index(me, 0), t1.$index(me, 1), t1.$index(me, 2)));
    if (typeof t2 !== "number")
      throw $.iae(t2);
    scaleX = 1 / t2;
    t2 = $.length1(vector.setValues$3(t1.$index(me, 4), t1.$index(me, 5), t1.$index(me, 6)));
    if (typeof t2 !== "number")
      throw $.iae(t2);
    scaleY = 1 / t2;
    t2 = $.length1(vector.setValues$3(t1.$index(me, 8), t1.$index(me, 9), t1.$index(me, 10)));
    if (typeof t2 !== "number")
      throw $.iae(t2);
    scaleZ = 1 / t2;
    t2 = $.getInterceptor$JSArray(te);
...
$$.Quaternion = {"": "Object;x=,y=,z=,w=",
  ...
  normalize$0: function() {
    ...
    if (l === 0) {
      ...
      t1 = this.x;
      if (typeof t1 !== "number")
        return this.normalize$0$bailout1(6, null, null, null, null, l, t1);
      this.x = t1 * l;
      t3 = this.y;
      if (typeof t3 !== "number")
        return this.normalize$0$bailout1(7, null, null, null, null, l, null, t3);
      this.y = t3 * l;
      t5 = this.z;
      if (typeof t5 !== "number")
        return this.normalize$0$bailout1(8, null, null, null, null, l, null, null, t5);
      this.z = t5 * l;
      t7 = this.w;
      if (typeof t7 !== "number")
        return this.normalize$0$bailout1(9, null, null, null, null, l, null, null, null, t7);
      this.w = t7 * l;
    }
    return this;
  },
  normalize$0$bailout1: function(state0, t1, t3, t5, t7, l, t2, t4, t6, t8) {
    switch (state0) {
      case 0:
        t1 = this.x;
      case 1:
...
$$.Vector4 = {"": "Object;x=,y=,z=,w=",
  ...
  normalize$0: function() {
    ...
    t7 = this.w;
    if (typeof t7 !== "number")
      return this.normalize$0$bailout0(4, t1, null, null, t7);
    return this.divideScalar$1(Math.sqrt($.checkNum(t1 + t7 * t7)));
  },
  normalize$0$bailout0: function(state0, t1, t3, t5, t7) {
    switch (state0) {
      case 0:
        t1 = this.x;
      case 1:
...
$$.Color = {"": "Object;r>,g>,b>",
  ...
  setHex$1: function(hex) {
    var t1, t2;
    t1 = $.toInt($.CONSTANT0.floor$0(hex));
    t2 = $.getInterceptor$JSNumber(t1);
...
$$.Geometry = {"": "Object;id>,name,vertices>,colors,materials>,faces>,faceUvs,faceVertexUvs>,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,__tmpVertices,boundingBox,boundingSphere>,hasTangents,_dynamic,bones,animation,__data",
  computeBoundingSphere$0: function() {
    var t1 = {};
    t1.radiusSq_0 = null;
    this.boundingSphere = $.BoundingSphere$(Math.sqrt($.checkNum($.CONSTANT1.reduce$2(this.vertices, 0, new $.Geometry_computeBoundingSphere_anon(t1)))));
  },
  get$_data: function() {
    if (this.__data == null)
      this.__data = $.makeLiteralMap([]);
...
$$.Vector2 = {"": "Object;x=,y=",
  ...
  multiplyScalar$1$bailout2: function(state0, s, t1, t3) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
  ...
  normalize$0$bailout2: function(state0, t1, t3) {
    switch (state0) {
      case 0:
        t1 = this.x;
      case 1:
    ...
    if (this._isEmpty) {
      ...
      if (x1 < x2)
        if (x1 < x3) {
          t1 = this._left;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(6, x1, y1, x2, y2, x3, y3, $.CONSTANT0, null, null, null, t1);
          if (x1 < t1)
            t1 = x1;
        } else {
          t1 = this._left;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(8, x1, y1, x2, y2, x3, y3, $.CONSTANT0, null, null, null, t1);
          if (x3 < t1)
            t1 = x3;
        }
      else if (x2 < x3) {
        t1 = this._left;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(10, x1, y1, x2, y2, x3, y3, $.CONSTANT0, t1, null, null, $.CONSTANT0);
        if (x2 < t1)
          t1 = x2;
      } else {
        t1 = this._left;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(12, x1, y1, x2, y2, x3, y3, $.CONSTANT0, null, null, null, t1);
        if (x3 < t1)
          t1 = x3;
      }
      this._left = t1;
      if (y1 < y2)
        if (y1 < y3) {
          t1 = this._top;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(14, x1, y1, x2, y2, x3, y3, $.CONSTANT0, t1, null, null, $.CONSTANT0);
          if (y1 < t1)
            t1 = y1;
        } else {
          t1 = this._top;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(16, x1, y1, x2, y2, x3, y3, $.CONSTANT0, t1, null, null, $.CONSTANT0);
          if (y3 < t1)
            t1 = y3;
        }
      else if (y2 < y3) {
        t1 = this._top;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(18, x1, y1, x2, y2, x3, y3, $.CONSTANT0, $.CONSTANT0, null, null, $.CONSTANT0, t1);
        if (y2 < t1)
          t1 = y2;
      } else {
        t1 = this._top;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(20, x1, y1, x2, y2, x3, y3, $.CONSTANT0, t1, null, null, $.CONSTANT0);
        if (y3 < t1)
          t1 = y3;
      }
      this._top = t1;
      if (x1 > x2)
        if (x1 > x3) {
          t1 = this._right;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(22, x1, y1, null, y2, null, y3, $.CONSTANT0, t1, null, null, $.CONSTANT0);
          if (x1 > t1)
            t1 = x1;
        } else {
          t1 = this._right;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(24, null, y1, null, y2, x3, y3, t1, null, null, null, $.CONSTANT0);
          if (x3 > t1)
            t1 = x3;
        }
      else if (x2 > x3) {
        t1 = this._right;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(26, null, y1, x2, y2, null, y3, $.CONSTANT0, t1, null, null, $.CONSTANT0);
        if (x2 > t1)
          t1 = x2;
      } else {
        t1 = this._right;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(28, null, y1, null, y2, x3, y3, t1, null, null, null, $.CONSTANT0);
        if (x3 > t1)
          t1 = x3;
      }
      this._right = t1;
      if (y1 > y2)
        if (y1 > y3) {
          t1 = this._bottom;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(30, null, y1, null, null, null, null, t1, null, null, null, $.CONSTANT0);
          if (y1 > t1)
            t1 = y1;
        } else {
          t1 = this._bottom;
        ...
        t1 = this._bottom;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(34, null, null, null, y2, null, null, $.CONSTANT0, null, null, null, t1);
        if (y2 > t1)
          t1 = y2;
      } else {
        t1 = this._bottom;
...
$$.CanvasRenderer = {"": "Object;domElement>,_autoClear,_sortObjects,_sortElements,_canvasWidth,_canvasHeight,_canvasWidthHalf,_canvasHeightHalf,_clearColor,_clearOpacity,_camera,_canvas,_context,_contextGlobalAlpha,_contextGlobalCompositeOperation,_contextStrokeStyle,_contextFillStyle,_contextLineCap,_contextLineJoin,_contextLineWidth,_clipRect,_clearRect,_bboxRect,_info,_renderData>,_elements,_lights,_projector,_v5,_v6,_v1x,_v1y,_v2x,_v2y,_v3x,_v3y,_v4x,_v4y,_v5x,_v5y,_v6x,_v6y,_color,_color1,_color2,_color3,_color4,_patterns,_imagedatas,_near,_far,_image,_uvs,_uv1x,_uv1y,_uv2x,_uv2y,_uv3x,_uv3y,_enableLighting,_ambientLight,_directionalLights,_pointLights,_pi2,_vector3,_pixelMapImage,_pixelMapData,_gradientMapQuality,_pixelMap,_pixelMapContext,_gradientMap,_gradientMapContext,debug",
  ...
  calculateLight$4: function(lights, position, normal, color) {
    var ll, l, lightPosition, amount, light, lightColor, t1, t2;
    if (typeof lights !== "string" && (typeof lights !== "object" || lights === null || lights.constructor !== Array && !lights.$isJavaScriptIndexingBehavior()))
  ...
  calculateLight$4$bailout: function(state0, lights, position, normal, color, t1, ll) {
    switch (state0) {
      ...
      case 1:
        ...
        ll = t1.get$length(lights);
      case 2:
        var l, lightPosition, amount, light, lightColor, t2, t3;
        state0 = 0;
        for (l = 0, lightPosition = null, amount = null; $.CONSTANT2.$lt(l, ll); ++l) {
          light = t1.$index(lights, l);
          lightColor = light.get$color();
          if (typeof light === "object" && light !== null && !!light.$isDirectionalLight) {
            lightPosition = light.matrixWorld.getPosition$0();
  ...
  renderParticle$4: function(v1, element, material, scene) {
    ...
    if (typeof material === "object" && material !== null && !!material.$isParticleBasicMaterial) {
      ...
      if (t1 === true) {
        ...
        t13 = v1.x;
        if (typeof t13 !== "number")
          return this.renderParticle$4$bailout(7, v1, element, bitmap, t1, t3, t5, null, t8, t10, $.CONSTANT0, height, t12, t13);
        t15 = t13 - t5;
        t16 = v1.y;
        if (typeof t16 !== "number")
          return this.renderParticle$4$bailout(8, v1, element, bitmap, t1, t3, t5, null, t8, t10, $.CONSTANT0, height, t12, t15, t16);
        ...
        t4 = element.rotation;
        if (typeof t4 !== "number")
          return this.renderParticle$4$bailout(11, v1, null, bitmap, t1, t3, null, null, t8, t10, $.CONSTANT0, null, null, null, null, null, t2, t4);
        t2.rotate$1(-t4);
...
$$.Canvas_Lines_init_anon = {"": "Closure;Tau_0",
...
$$.Canvas_Lines_init_anon0 = {"": "Closure;this_1",
  call$0: function() {
...
$.Canvas_Lines$ = function() {
  return new $.Canvas_Lines(null, null, null, null, null, null, 0, 0, 0, 0);
};
