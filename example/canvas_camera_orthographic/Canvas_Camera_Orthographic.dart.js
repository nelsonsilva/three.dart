...
$$.Canvas_Camera_Orthographic = {"": "Object;container,camera,scene,renderer,windowHalfX,windowHalfY",
  run$0: function() {
    this.init$0();
  ...
  init$0: function() {
    var info, t1, t2, t3, geometry, i, line, material, rnd, cube, ambientLight, directionalLight;
    ...
    t1 = $.$$negate(this.windowHalfX);
    t2 = this.windowHalfX;
    t3 = this.windowHalfY;
    this.camera = $.OrthographicCamera$(t1, t2, t3, $.$$negate(t3), -2000, 1000);
    this.camera.get$position().set$x(200);
    this.camera.get$position().set$y(100);
    this.camera.get$position().set$z(200);
    this.scene = $.Scene$();
    geometry = $.Geometry$();
    geometry.vertices.push($.Vector3$(-500, 0, 0));
    geometry.vertices.push($.Vector3$(500, 0, 0));
    for (i = 0; i <= 20; ++i) {
      line = $.Line$(geometry, $.LineBasicMaterial$(0, 205, 100, 204, 1, 0, true, true, true, "round", "round", 1, "", 0.2, false, false, 0, 0, 0, false, 0, true), 0);
      t1 = i * 50 - 500;
    ...
    geometry = $.CubeGeometry$(50, 50, 50, 1, 1, 1, null, null);
    material = $.MeshLambertMaterial$(0, 16777215, 205, 100, 204, 1, 16777215, 0, true, true, 0, null, true, null, null, false, false, "", 1, true, false, 0, 0, 1, 0.98, 2, 0, false, null, false, 0, true, false, "round", "round", 1, false, null);
    ...
    for (i = 0; i < 100; ++i) {
      ...
      t1 = $.$$div($.$$mul(t2.y, 50), 2);
      cube.position.set$y(t1);
      t1 = $.$$add($.$$mul($.floor($.$$div($.$$sub(rnd.nextInt$1(1000), 500), 50)), 50), 25);
      cube.position.set$z(t1);
      $.add(this.scene, cube);
    }
    ambientLight = $.AmbientLight$($.$$mul(rnd.nextDouble$0(), 16));
    $.add(this.scene, ambientLight);
    ...
    $.add(this.scene, directionalLight);
    directionalLight = $.DirectionalLight$($.$$mul(rnd.nextDouble$0(), 16777215), 1, 0);
    t1 = $.$$sub(rnd.nextDouble$0(), 0.5);
    directionalLight.position.set$x(t1);
    t1 = $.$$sub(rnd.nextDouble$0(), 0.5);
  ...
  render$0: function() {
    var t1, t2, t3;
    t1 = $.$$mul($.Date_Date$now().get$millisecondsSinceEpoch(), 0.0001);
    t2 = Math.cos($.checkNum(t1));
    this.camera.get$position().set$x(t2 * 200);
    t3 = Math.sin($.checkNum(t1));
    this.camera.get$position().set$z(t3 * 200);
...
$$.Vector3 = {"": "Object;x=,y=,z=",
  ...
  divideScalar$1: function(s) {
    ...
    if (!(s === 0)) {
      ...
      t5 = this.z;
      if (typeof t5 !== "number")
        return this.divideScalar$1$bailout(3, s, null, null, t5);
      this.z = t5 / s;
    } else {
      this.x = 0;
      this.y = 0;
  ...
  divideScalar$1$bailout: function(state0, s, t1, t3, t5) {
    switch (state0) {
      case 0:
      default:
        if (state0 === 3 || state0 === 2 || state0 === 1 || state0 === 0 && !(s === 0))
          switch (state0) {
            case 0:
              t1 = this.x;
            case 1:
...
$$.Matrix4 = {"": "Object;elements=",
  ...
  makeOrthographic$6: function(left, right, top, bottom, near, far) {
    var te, t1, w, t2, h, t3, p, t4, t5, t6, t7;
    te = this.elements;
    t1 = $.getInterceptor$JSNumber(right);
    w = t1.$sub(right, left);
    t2 = $.getInterceptor$JSNumber(top);
    h = t2.$sub(top, bottom);
    t3 = $.getInterceptor$JSNumber(far);
    p = t3.$sub(far, near);
    t4 = $.$$div(t1.$add(right, left), w);
    t5 = $.$$div(t2.$add(top, bottom), h);
    t6 = $.$$div(t3.$add(far, near), p);
    if (typeof w !== "number")
      throw $.iae(w);
    t7 = $.getInterceptor$JSArray(te);
    t7.$indexSet(te, 0, 2 / w);
    t7.$indexSet(te, 4, 0);
    t7.$indexSet(te, 8, 0);
    t7.$indexSet(te, 12, $.$$negate(t4));
    t7.$indexSet(te, 1, 0);
    if (typeof h !== "number")
      throw $.iae(h);
    t7.$indexSet(te, 5, 2 / h);
    t7.$indexSet(te, 9, 0);
    t7.$indexSet(te, 13, $.$$negate(t5));
    t7.$indexSet(te, 2, 0);
    t7.$indexSet(te, 6, 0);
    if (typeof p !== "number")
      throw $.iae(p);
    t7.$indexSet(te, 10, -2 / p);
    t7.$indexSet(te, 14, $.$$negate(t6));
    t7.$indexSet(te, 3, 0);
    t7.$indexSet(te, 7, 0);
    t7.$indexSet(te, 11, 0);
    t7.$indexSet(te, 15, 1);
...
$$.Vector4 = {"": "Object;x=,y=,z=,w=",
  ...
  divideScalar$1: function(s) {
    ...
    t1 = this.x;
    if (typeof t1 !== "number")
      return this.divideScalar$1$bailout1(1, s, t1);
    this.x = t1 / s;
    t3 = this.y;
    if (typeof t3 !== "number")
      return this.divideScalar$1$bailout1(2, s, null, t3);
    this.y = t3 / s;
    t5 = this.z;
    if (typeof t5 !== "number")
      return this.divideScalar$1$bailout1(3, s, null, null, t5);
    this.z = t5 / s;
    t7 = this.w;
    if (typeof t7 !== "number")
      return this.divideScalar$1$bailout1(4, s, null, null, null, t7);
    this.w = t7 / s;
    return this;
  },
...
$$.Vector2 = {"": "Object;x=,y=",
  ...
  divideScalar$1$bailout0: function(state0, s, t1, t3) {
    switch (state0) {
      case 0:
        t1 = this.x;
      case 1:
...
$$.Rectangle = {"": "Object;_left,_top,_right,_bottom,_width,_height,_isEmpty",
  ...
  get$resize: function() {
    return new $.BoundClosure3(this, "resize$0");
  },
  getX$0: function() {
    return this._left;
  },
...
$$.CubeGeometry = {"": "Geometry;_sides,segmentsWidth,segmentsHeight,segmentsDepth,id,name,vertices,colors,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  ...
  CubeGeometry$8: function(width, height, depth, segmentsWidth, segmentsHeight, segmentsDepth, materialOrList, sides) {
    var t1, t2, t3, i, mpx, mpy, mpz, mny, mnx, mnz, t4, t5, t6;
...
$$.AmbientLight = {"": "Light;color,id,name,properties,parent,children,up,position,rotation,scale,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth,matrix,matrixWorld,matrixRotationWorld,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible,castShadow,receiveShadow,frustumCulled,_vector,__data", $isAmbientLight: true};
  ...
  calculateLight$4$bailout: function(state0, lights, position, normal, color, t1, ll) {
    switch (state0) {
      ...
      case 2:
        ...
        state0 = 0;
        for (amount = null, l = 0, lightPosition = null; $.CONSTANT0.$lt(l, ll); ++l) {
          light = t1.$index(lights, l);
          lightColor = light.get$color();
          if (typeof light === "object" && light !== null && !!light.$isDirectionalLight) {
            lightPosition = light.matrixWorld.getPosition$0();
...
//@ sourceMappingURL=Canvas_Camera_Orthographic.dart.js.map