...
$$.Canvas_Geometry_Cube = {"": "Object;container,camera,scene,renderer,cube,plane,targetRotation,targetRotationOnMouseDown,mouseX,mouseXOnMouseDown,windowHalfX,windowHalfY",
  run$0: function() {
    this.init$0();
    this.animate$0();
  },
  init$0: function() {
    var info, materials, rnd, i;
    ...
    this.scene = $.Scene$();
    this.camera = $.PerspectiveCamera$(70, $.$$div(window.get$innerWidth(), window.get$innerHeight()), 1, 1000);
    this.camera.get$position().set$y(150);
    this.camera.get$position().set$z(500);
    $.add(this.scene, this.camera);
    materials = [];
    rnd = $.Random_Random(null);
    for (i = 0; i < 6; ++i)
      materials.push($.MeshBasicMaterial$(0, 205, 100, 204, 1, $.$$mul(rnd.nextDouble$0(), 16777215), 0, true, true, null, true, null, null, false, "", 1, false, false, 0, 0, 1, 0.98, 2, 0, false, null, false, 0, true, false, "round", "round", 1));
    this.cube = $.Mesh$($.CubeGeometry$(200, 200, 200, 1, 1, 1, materials, null), $.MeshFaceMaterial$());
    this.cube.get$position().set$y(150);
    $.add(this.scene, this.cube);
    this.plane = $.Mesh$($.PlaneGeometry$(200, 200, null, null), $.MeshBasicMaterial$(0, 205, 100, 204, 1, 14737632, 0, true, true, null, true, null, null, false, "", 1, true, false, 0, 0, 1, 0.98, 2, 0, false, null, false, 0, true, false, "round", "round", 1));
    this.plane.get$rotation().set$x(-1.5707963267948966);
    $.add(this.scene, this.plane);
    ...
    $.add(document.get$on().get$mouseDown(), this.get$onDocumentMouseDown());
    ...
    window.setInterval$2(new $.Canvas_Geometry_Cube_init_anon(this), 10);
  },
  onDocumentMouseDown$1: function(event) {
    event.preventDefault$0();
    $.add(document.get$on().get$mouseMove(), this.get$onDocumentMouseMove());
    $.add(document.get$on().get$mouseUp(), this.get$onDocumentMouseUp());
    $.add(document.get$on().get$mouseOut(), this.get$onDocumentMouseOut());
    this.mouseXOnMouseDown = $.$$sub(event.get$clientX(), this.windowHalfX);
    this.targetRotationOnMouseDown = this.targetRotation;
    $.print("onMouseDown mouseX = " + $.S(this.mouseXOnMouseDown) + " targRot = " + $.S(this.targetRotationOnMouseDown));
  },
  ...
  onDocumentMouseMove$1: function(event) {
    ...
    this.targetRotation = $.$$add(this.targetRotationOnMouseDown, $.$$mul($.$$sub(this.mouseX, this.mouseXOnMouseDown), 0.02));
    $.print("onMouseMove mouseX = " + $.S(this.mouseX) + " targRot = " + $.S(this.targetRotation));
  },
  ...
  onDocumentMouseUp$1: function(event) {
    ...
    $.remove(document.get$on().get$mouseMove(), this.get$onDocumentMouseMove());
    $.remove(document.get$on().get$mouseUp(), this.get$onDocumentMouseUp());
    $.remove(document.get$on().get$mouseOut(), this.get$onDocumentMouseOut());
  },
  ...
  onDocumentTouchMove$1: function(event) {
    if ($.$$eq($.length(event.get$touches()), 1) === true) {
      ...
      this.targetRotation = $.$$add(this.targetRotationOnMouseDown, $.$$mul($.$$sub(this.mouseX, this.mouseXOnMouseDown), 0.05));
    }
  },
  ...
  render$0: function() {
    var t1, t2;
    t1 = this.cube.get$rotation();
    t2 = t1.get$y();
    t2 = $.$$add(t2, $.$$mul($.$$sub(this.targetRotation, t2), 0.05));
    t1.set$y(t2);
    this.plane.get$rotation().set$z(t2);
...
$$.Color = {"": "Object;r>,g>,b>",
  ...
  setHex$1: function(hex) {
    var t1, t2;
    t1 = $.toInt($.CONSTANT1.floor$0(hex));
    t2 = $.getInterceptor$JSNumber(t1);
...
$$.CubeGeometry = {"": "Geometry;_sides,segmentsWidth,segmentsHeight,segmentsDepth,id,name,vertices,colors,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  ...
  CubeGeometry$8: function(width, height, depth, segmentsWidth, segmentsHeight, segmentsDepth, materialOrList, sides) {
    var t1, t2, t3, i, mny, mpx, mpy, mnx, mnz, mpz, t4, t5, t6;
...
$$.PlaneGeometry = {"": "Geometry;id,name,vertices,colors,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  PlaneGeometry$4: function(width, height, segmentsWidth, segmentsHeight) {
    var t1, width_half, t3, height_half, gridX, gridY, t2, t4, segment_width, segment_height, normal, iy, ix, iy0, t5, t6, ix0, face, faceVertexUV, newUVs, t7, t8;
    ...
    width_half = t1.$div(width, 2);
    if (typeof width_half !== "number")
      return this.PlaneGeometry$4$bailout(2, width, height, segmentsWidth, segmentsHeight, t1, width_half);
    t3 = $.getInterceptor$JSNumber(height);
    height_half = t3.$div(height, 2);
    if (typeof height_half !== "number")
      return this.PlaneGeometry$4$bailout(3, width, height, segmentsWidth, segmentsHeight, t1, width_half, t3, height_half);
    gridX = segmentsWidth;
    gridY = segmentsHeight;
    t2 = gridX + 1;
    t4 = gridY + 1;
    segment_width = t1.$div(width, gridX);
    if (typeof segment_width !== "number")
      return this.PlaneGeometry$4$bailout(4, null, height, null, null, null, width_half, t3, height_half, t2, gridY, t4, segment_width, gridX);
    segment_height = t3.$div(height, gridY);
    if (typeof segment_height !== "number")
      return this.PlaneGeometry$4$bailout(5, null, null, null, null, null, width_half, null, height_half, t2, gridY, t4, segment_width, gridX, segment_height);
    normal = $.Vector3$(0, 0, 1);
    for (iy = 0; iy < t4; ++iy)
      for (t1 = -(iy * segment_height - height_half), ix = 0; ix < t2; ++ix)
        this.vertices.push($.Vector3$(ix * segment_width - width_half, t1, 0));
    for (t1 = this.faceVertexUvs, iy = 0; iy < gridY; iy = iy0)
      for (iy0 = iy + 1, t3 = t2 * iy, t4 = t2 * iy0, t5 = iy / gridY, t6 = iy0 / gridY, ix = 0; ix < gridX; ix = ix0) {
        ix0 = ix + 1;
        face = $.Face4$(ix + t3, ix + t4, ix0 + t4, ix0 + t3, null, null, null);
        face.normal.copy$1(normal);
        $.addAll(face.vertexNormals, [normal.clone$0(), normal.clone$0(), normal.clone$0(), normal.clone$0()]);
        this.faces.push(face);
        if (0 >= t1.length)
        ...
        t7 = ix / gridX;
        t8 = ix0 / gridX;
        $.CONSTANT2.addAll$1(newUVs, [$.UV$(t7, t5), $.UV$(t7, t6), $.UV$(t8, t6), $.UV$(t8, t5)]);
        $.add(faceVertexUV, newUVs);
      }
    this.computeCentroids$0();
  },
  PlaneGeometry$4$bailout: function(state0, width, height, segmentsWidth, segmentsHeight, t1, width_half, t3, height_half, t2, gridY, t4, segment_width, gridX, segment_height) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
      ...
      case 4:
        ...
        segment_height = t3.$div(height, gridY);
      case 5:
        var normal, iy, ix, iy0, t5, ix0, t6, t7, face, faceVertexUV, newUVs, t8, t9, t10, t11;
        state0 = 0;
        normal = $.Vector3$(0, 0, 1);
        for (iy = 0; $.CONSTANT0.$lt(iy, t4); ++iy)
          for (ix = 0; $.CONSTANT0.$lt(ix, t2); ++ix) {
            if (typeof segment_width !== "number")
              throw $.iae(segment_width);
            if (typeof width_half !== "number")
              throw $.iae(width_half);
            ...
            if (typeof height_half !== "number")
              throw $.iae(height_half);
            this.vertices.push($.Vector3$(ix * segment_width - width_half, -(iy * segment_height - height_half), 0));
          }
        for (t1 = $.getInterceptor$JSNumber(t2), t3 = this.faceVertexUvs, iy = 0; $.CONSTANT0.$lt(iy, gridY); iy = iy0)
          for (iy0 = iy + 1, ix = 0; $.CONSTANT0.$lt(ix, gridX); ix = ix0) {
            t4 = t1.$mul(t2, iy);
            if (typeof t4 !== "number")
              throw $.iae(t4);
            ...
            if (typeof t7 !== "number")
              throw $.iae(t7);
            face = $.Face4$(ix + t4, ix + t5, ix0 + t6, ix0 + t7, null, null, null);
            face.normal.copy$1(normal);
            $.addAll(face.vertexNormals, [normal.clone$0(), normal.clone$0(), normal.clone$0(), normal.clone$0()]);
            this.faces.push(face);
            if (0 >= t3.length)
...
$$.MeshFaceMaterial = {"": "Material;name,id,side,opacity,blending,blendSrc,blendDst,blendEquation,alphaTest,polygonOffset,polygonOffsetFactor,polygonOffsetUnits,transparent,depthTest,depthWrite,overdraw,visible,needsUpdate,__data", $isMeshFaceMaterial: true};
...
$$.Canvas_Geometry_Cube_init_anon = {"": "Closure;this_0",
  call$0: function() {
...
$.Canvas_Geometry_Cube$ = function() {
  return new $.Canvas_Geometry_Cube(null, null, null, null, null, null, null, null, null, null, null, null);
};

$.main = function() {
  $.Canvas_Geometry_Cube$().run$0();
};
...
$.MeshFaceMaterial$ = function() {
  ...
  $.MaterialCount = $.$$add(t1, 1);
  return new $.MeshFaceMaterial("", t1, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null);
};
...
(function() {
  ...
  $.dynamicSetMetadata([["StyleSheet", "StyleSheet|CSSStyleSheet"], ["MouseEvent", v0_MouseEvent], ["UIEvent", v5_UIEvent], ["Uint8Array", "Uint8Array|Uint8ClampedArray"], ["CSSValueList", "CSSValueList|WebKitCSSFilterValue|WebKitCSSMixFunctionValue|WebKitCSSTransformValue"], ["SVGComponentTransferFunctionElement", v2_ComponentTransferFunctionElement], ["Blob", "Blob|File"], ["CharacterData", v8_CharacterData], ["CSSRule", "CSSRule|CSSUnknownRule|CSSStyleRule|CSSPageRule|CSSFontFaceRule|WebKitCSSKeyframesRule|CSSMediaRule|CSSCharsetRule|WebKitCSSKeyframeRule|CSSImportRule"], ["Document", v9_Document], ["DocumentFragment", v7_DocumentFragment], ["HTMLMediaElement", v3_MediaElement], ["SVGTextPositioningElement", v1_TextPositioningElement], ["SVGElement", v4_SvgElement], ["Element", v6_Element], ["Entry", "Entry|DirectoryEntry|FileEntry"], ["EntrySync", "EntrySync|FileEntrySync|DirectoryEntrySync"], ["Event", [v5_UIEvent, "Event|ProgressEvent|XMLHttpRequestProgressEvent|RTCDataChannelEvent|RTCIceCandidateEvent|SpeechInputEvent|SpeechRecognitionError|SpeechRecognitionEvent|StorageEvent|TrackEvent|WebKitTransitionEvent|WebGLContextEvent|IDBVersionChangeEvent|IDBVersionChangeEvent|DeviceMotionEvent|BeforeLoadEvent|CloseEvent|DeviceOrientationEvent|CustomEvent|ErrorEvent|HashChangeEvent|AudioProcessingEvent|OfflineAudioCompletionEvent|WebKitAnimationEvent|MediaKeyEvent|MediaStreamEvent|MediaStreamTrackEvent|MessageEvent|MutationEvent|OverflowEvent|PageTransitionEvent|PopStateEvent"].join("|")], ["Node", v10_Node], ["MediaStream", v11_MediaStream], ["EventTarget", [v10_Node, v11_MediaStream, "EventTarget|SourceBufferList|TextTrack|TextTrackCue|TextTrackList|DOMWindow|SVGElementInstance"].join("|")], ["HTMLCollection", "HTMLCollection|HTMLFormControlsCollection|HTMLOptionsCollection"], ["NodeList", "NodeList|RadioNodeList"]]);
})();
...
//@ sourceMappingURL=Canvas_Geometry_Cube.dart.js.map