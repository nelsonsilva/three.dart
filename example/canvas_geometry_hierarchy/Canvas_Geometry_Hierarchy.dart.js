...
$$.Canvas_Geometry_Hierarchy = {"": "Object;container,camera,scene,renderer,geometry>,group,mouseX,mouseY,windowHalfX,windowHalfY",
  run$0: function() {
  ...
  init$0: function() {
    var materials, rnd, i, material, mesh, t1, t2;
    ...
    this.scene = $.Scene$();
    this.camera = $.PerspectiveCamera$(60, $.$$div(window.get$innerWidth(), window.get$innerHeight()), 1, 10000);
    ...
    this.geometry = $.CubeGeometry$(100, 100, 100, 1, 1, 1, null, null);
    material = $.MeshNormalMaterial$(0, 205, 100, 204, 1, true, true, "", 1, false, false, 0, 0, 1, 0, false, true, false, 1);
    this.group = $.Object3D$();
    for (i = 0; i < 200; ++i) {
      mesh = $.Mesh$(this.geometry, material);
      t1 = $.$$sub(rnd.nextInt$1(2000), 1000);
      t2 = mesh.position;
      t2.x = t1;
      t2.y = $.$$sub(rnd.nextInt$1(2000), 1000);
      t2.z = $.$$sub(rnd.nextInt$1(2000), 1000);
      t2 = $.$$mul(rnd.nextInt$1(360), 0.017453292519943295);
      mesh.rotation.set$x(t2);
      t2 = $.$$mul(rnd.nextInt$1(360), 0.017453292519943295);
      mesh.rotation.set$y(t2);
      mesh.matrixAutoUpdate = false;
      mesh.updateMatrix$0();
      $.add(this.group, mesh);
    }
    $.add(this.scene, this.group);
    ...
    window.setInterval$2(new $.Canvas_Geometry_Hierarchy_init_anon(this), 10);
  },
  onDocumentMouseMove$1: function(event) {
    this.mouseX = $.$$mul($.$$sub(event.get$clientX(), this.windowHalfX), 10);
    this.mouseY = $.$$mul($.$$sub(event.get$clientY(), this.windowHalfY), 10);
  },
  ...
  render$0: function() {
    ...
    t1 = this.camera.get$position();
    t1.set$y($.$$add(t1.get$y(), $.$$mul($.$$sub($.$$negate(this.mouseY), this.camera.get$position().get$y()), 0.05)));
    this.camera.lookAt$1(this.scene.get$position());
    oscillate = new $.Canvas_Geometry_Hierarchy_render_anon($.Date_Date$now().get$millisecondsSinceEpoch());
    t1 = oscillate.call$1(0.0007);
    this.group.get$rotation().set$x(t1);
    t1 = oscillate.call$1(0.0003);
    this.group.get$rotation().set$y(t1);
    t1 = oscillate.call$1(0.0002);
    this.group.get$rotation().set$z(t1);
...
$$.Object3D = {"": "Object;id>,name>,properties,parent=,children>,up,position>,rotation=,scale>,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth>,matrix,matrixWorld>,matrixRotationWorld>,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible=,castShadow,receiveShadow,frustumCulled>,_vector,__data",
  ...
  updateMatrix$0: function() {
    ...
    t3 = t2.x;
    if (typeof t3 !== "number")
      return this.updateMatrix$0$bailout(1, t1, t2, t3);
    if (t3 === 1) {
      t3 = t2.y;
      if (typeof t3 !== "number")
        return this.updateMatrix$0$bailout(2, t1, t2, t3);
      if (t3 === 1) {
        t3 = t2.z;
        if (typeof t3 !== "number")
          return this.updateMatrix$0$bailout(3, t1, t2, t3);
        t5 = !(t3 === 1);
        t3 = t5;
      } else
        t3 = true;
  ...
  updateMatrix$0$bailout: function(state0, t1, t2, t3) {
    switch (state0) {
      case 0:
        t1 = this.matrix;
        t1.setPosition$1(this.position);
      ...
      default:
        var t5;
        if (state0 === 3 || state0 === 2 || state0 === 0 && $.$$eq(t3, 1) === true)
          switch (state0) {
            case 0:
              t3 = t2.y;
            case 2:
              state0 = 0;
            case 3:
              if (state0 === 3 || state0 === 0 && $.$$eq(t3, 1) === true)
                switch (state0) {
                  case 0:
                    t3 = t2.z;
                  case 3:
...
$$.CubeGeometry = {"": "Geometry;_sides,segmentsWidth,segmentsHeight,segmentsDepth,id,name,vertices,colors,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  ...
  CubeGeometry$8: function(width, height, depth, segmentsWidth, segmentsHeight, segmentsDepth, materialOrList, sides) {
    var t1, t2, t3, i, mpy, mnx, mpx, mpz, mny, mnz, t4, t5, t6;
...
$$.MeshNormalMaterial = {"": "Material;shading,wireframe,wireframeLinewidth,wireframeLinecap,wireframeLinejoin,name,id,side,opacity,blending,blendSrc,blendDst,blendEquation,alphaTest,polygonOffset,polygonOffsetFactor,polygonOffsetUnits,transparent,depthTest,depthWrite,overdraw,visible,needsUpdate,__data", $isMeshNormalMaterial: true};
...
$$.Mesh = {"": "Object3D;geometry>,material=,morphTargetBase,morphTargetForcedOrder,morphTargetInfluences,_morphTargetDictionary,id,name,properties,parent,children,up,position,rotation,scale,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth,matrix,matrixWorld,matrixRotationWorld,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible,castShadow,receiveShadow,frustumCulled,_vector,__data",
  Mesh$2: function(geometry, material) {
    ...
    if (!(t1 == null)) {
      ...
      if ($.$$eq($.length(this.geometry.get$morphTargets()), 0) !== true) {
        this.morphTargetBase = -1;
        this.morphTargetForcedOrder = [];
        this.morphTargetInfluences = [];
        this._morphTargetDictionary = $.makeLiteralMap([]);
        for (m = 0; $.CONSTANT0.$lt(m, $.length(this.geometry.get$morphTargets())); ++m) {
...
$$.CanvasRenderer = {"": "Object;domElement>,_autoClear,_sortObjects,_sortElements,_canvasWidth,_canvasHeight,_canvasWidthHalf,_canvasHeightHalf,_clearColor,_clearOpacity,_camera,_canvas,_context,_contextGlobalAlpha,_contextGlobalCompositeOperation,_contextStrokeStyle,_contextFillStyle,_contextLineCap,_contextLineJoin,_contextLineWidth,_clipRect,_clearRect,_bboxRect,_info,_renderData>,_elements,_lights,_projector,_v5,_v6,_v1x,_v1y,_v2x,_v2y,_v3x,_v3y,_v4x,_v4y,_v5x,_v5y,_v6x,_v6y,_color,_color1,_color2,_color3,_color4,_patterns,_imagedatas,_near,_far,_image,_uvs,_uv1x,_uv1y,_uv2x,_uv2y,_uv3x,_uv3y,_enableLighting,_ambientLight,_directionalLights,_pointLights,_pi2,_vector3,_pixelMapImage,_pixelMapData,_gradientMapQuality,_pixelMap,_pixelMapContext,_gradientMap,_gradientMapContext,debug",
  set$sortObjects: function(value) {
...
$$.Canvas_Geometry_Hierarchy_render_anon = {"": "Closure;t_0",
  call$1: function(rate) {
    return Math.sin($.checkNum($.$$mul(this.t_0, rate))) * 0.5;
  }
};
...
$$.Canvas_Geometry_Hierarchy_init_anon = {"": "Closure;this_0",
  call$0: function() {
...
$.Canvas_Geometry_Hierarchy$ = function() {
  return new $.Canvas_Geometry_Hierarchy(null, null, null, null, null, null, 0, 0, null, null);
};

$.main = function() {
  $.Canvas_Geometry_Hierarchy$().run$0();
};
...
$.MeshNormalMaterial$ = function(alphaTest, blendDst, blendEquation, blendSrc, blending, depthTest, depthWrite, name, opacity, overdraw, polygonOffset, polygonOffsetFactor, polygonOffsetUnits, shading, side, transparent, visible, wireframe, wireframeLinewidth) {
  var t1 = $.MaterialCount;
  $.MaterialCount = $.$$add(t1, 1);
  return new $.MeshNormalMaterial(shading, wireframe, wireframeLinewidth, null, null, name, t1, side, opacity, blending, blendSrc, blendDst, blendEquation, alphaTest, polygonOffset, polygonOffsetFactor, polygonOffsetUnits, transparent, depthTest, depthWrite, overdraw, visible, true, null);
};
...
//@ sourceMappingURL=Canvas_Geometry_Hierarchy.dart.js.map