    ...
    switch (state0) {
      ...
      case 2:
        ...
        if (t2 == null)
          ...
          t3 = $.toString(t1.sb_0);
          t1.sb_0 = $.StringBuffer_StringBuffer("");
          for (t4 = $.getInterceptor$JSStringJSArray(t2), i = 0; $.CONSTANT6.$lt(i, t4.get$length(t2)); ++i) {
            if (i > 0)
              $.add(t1.sb_0, ", ");
  ...
  _probeForAdding$1: function(key) {
    ...
    for (numberOfProbes = 1, insertionIndex = -1; true; numberOfProbes = numberOfProbes0) {
      ...
      if (existingKey == null) {
        ...
        return hash;
      else if (insertionIndex < 0 && existingKey === $.CONSTANT9)
        insertionIndex = hash;
  ...
  $$indexSet$bailout1: function(state0, key, value, t1, index) {
    switch (state0) {
      case 0:
        ...
        t1 = t1[index];
      case 1:
        if (state0 === 1 || state0 === 0 && (t1 == null || t1 === $.CONSTANT9))
          switch (state0) {
            case 0:
              t1 = this._numberOfEntries;
            case 1:
  ...
  moveNext$0: function() {
    ...
    for (t3 = t1.get$_keys(); newIndex < t2;) {
      if (typeof t3 !== "string" && (typeof t3 !== "object" || t3 === null || t3.constructor !== Array && !t3.$isJavaScriptIndexingBehavior()))
        return this.moveNext$0$bailout(3, t2, t1, t3, newIndex, $.CONSTANT7);
      if (newIndex !== (newIndex | 0))
        throw $.iae(newIndex);
      if (newIndex < 0 || newIndex >= t3.length)
        throw $.ioore(newIndex);
      t5 = t3[newIndex];
      if (!(t5 == null) && !(t5 === $.CONSTANT9)) {
...
$$._HashSetIterator = {"": "Object;_keysIterator",
  ...
  moveNext$0: function() {
    ...
    do {
      ...
      if (result === true)
        t2 = t1.get$current() == null || t1.get$current() === $.CONSTANT9;
      else
        t2 = false;
    } while (t2);
    return result;
  ...
  _deserializeMap$1$bailout: function(state0, x, result, keys, t1, values, t3, len) {
    switch (state0) {
      ...
      case 3:
        var id, t2, i;
        state0 = 0;
        for (t1 = $.getInterceptor$JSStringJSArray(values), t2 = $.getInterceptor$JSArray(result), i = 0; $.CONSTANT6.$lt(i, len); ++i)
...
$$.Game = {"": "Object;container,camera,scene,renderer,controls,particles",
  init$0: function() {
    ...
    this.particles = $.List_List(0);
    this.makeParticles$0();
    $.add(this.container.get$nodes(), this.renderer.get$domElement());
    this.controls = $.FirstPersonControls$(this.camera, this.renderer.get$domElement());
    this.controls.set$movementSpeed(2);
  },
  makeParticles$0: function() {
    var rng, i, particle, t1, t2;
    rng = $.Random_Random(null);
    for (i = 0; i < 500; ++i) {
      particle = $.Particle$($.ParticleCanvasMaterial$(0, 205, 100, 204, 1, $.$$add($.$$mul(rng.nextDouble$0(), 8421504), 8421504), true, true, "", 1, false, false, 0, 0, this.get$particleRender(), 0, false, true));
      t1 = $.$$sub($.$$mul(rng.nextDouble$0(), 1000), 500);
      t2 = particle.position;
      t2.x = t1;
      t2.y = $.$$sub($.$$mul(rng.nextDouble$0(), 1000), 500);
      t2.z = $.$$sub($.$$mul(rng.nextDouble$0(), 1000), 500);
      t2 = $.$$add($.$$mul(rng.nextDouble$0(), 10), 10);
      t1 = particle.scale;
      t1.y = t2;
      t1.x = t2;
  ...
  particleRender$1: function(context) {
    context.beginPath$0();
    context.arc$6(0, 0, 1, 0, 6.283185307179586, true);
    context.fill$0();
  },
  get$particleRender: function() {
    return new $.BoundClosure(this, "particleRender$1");
  },
  animate$1: function(timestamp) {
    window.requestAnimationFrame$1(this.get$animate());
    this.controls.update$1(1);
...
$$.PerspectiveCamera = {"": "Camera;fov,aspect,_fullWidth,_fullHeight,_x,_y,_width,_height,matrixWorldInverse,projectionMatrix,projectionMatrixInverse,near,far,id,name,properties,parent,children,up,position,rotation,scale,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth,matrix,matrixWorld,matrixRotationWorld,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible,castShadow,receiveShadow,frustumCulled,_vector,__data",
  updateProjectionMatrix$0: function() {
    ...
    if (!(t1 == null)) {
      ...
      height = $.CONSTANT11.abs$0(top - bottom);
      t9 = this._x;
      t10 = $.getInterceptor$JSNumber(left);
      t11 = t10.$add(left, $.$$div($.CONSTANT6.$mul(t9, t8), t1));
      t10 = t10.$add(left, $.$$div($.$$mul($.CONSTANT6.$add(t9, t8), t8), t1));
      t12 = this._y;
      t13 = $.$$div($.$$mul($.CONSTANT6.$add(t12, height), height), t6);
      if (typeof t13 !== "number")
        throw $.iae(t13);
      t6 = $.$$div($.CONSTANT6.$mul(t12, height), t6);
      if (typeof t6 !== "number")
        throw $.iae(t6);
...
$$.Vector3 = {"": "Object;x=,y=,z=",
  ...
  sub$2: function(v1, v2) {
    ...
    t3 = v2.get$x();
    if (typeof t1 !== "number")
      return this.sub$2$bailout(1, v1, v2, t1);
    if (typeof t3 !== "number")
    ...
    t7 = v2.get$y();
    if (typeof t5 !== "number")
      return this.sub$2$bailout(3, v1, v2, null, null, t5);
    if (typeof t7 !== "number")
      return this.sub$2$bailout(4, v1, v2, null, null, t5, t7);
    this.y = t5 - t7;
    t9 = v1.get$z();
    t11 = v2.get$z();
    if (typeof t9 !== "number")
      return this.sub$2$bailout(5, null, v2, null, null, null, null, t9);
    if (typeof t11 !== "number")
      return this.sub$2$bailout(6, null, null, null, null, null, null, t9, t11);
    this.z = t9 - t11;
    return this;
  },
  sub$2$bailout: function(state0, v1, v2, t1, t3, t5, t7, t9, t11) {
    switch (state0) {
      case 0:
        t1 = v1.get$x();
      case 1:
...
$$.Matrix4 = {"": "Object;elements=",
  ...
  setPosition$1: function(v) {
    ...
    te = this.elements;
    t1 = $.getInterceptor$JSArray(te);
    t1.$indexSet(te, 12, v.x);
    t1.$indexSet(te, 13, v.y);
    t1.$indexSet(te, 14, v.z);
    return this;
  },
...
$$.Vector4 = {"": "Object;x=,y=,z=,w=",
  ...
  sub$2: function(v1, v2) {
    this.x = $.$$sub(v1.x, v2.x);
    this.y = $.$$sub(v1.y, v2.y);
    this.z = $.$$sub(v1.z, v2.z);
...
$$.Object3D = {"": "Object;id=,parent=,children>,position>,rotation=,scale>,renderDepth>,matrixWorld>,matrixRotationWorld>,visible=,frustumCulled>",
  ...
  translateX$1: function(distance) {
    return this.translate$2(distance, this._vector.setValues$3(1, 0, 0));
  },
  translateY$1: function(distance) {
    return this.translate$2(distance, this._vector.setValues$3(0, 1, 0));
  },
  translateZ$1: function(distance) {
    return this.translate$2(distance, this._vector.setValues$3(0, 0, 1));
  },
  lookAt$1: function(vector) {
    var t1 = this.matrix;
  ...
  remove$1: function(object) {
    var t1, scene;
    t1 = $.indexOf(this.children, object);
    if (typeof t1 !== "number")
...
$$.Color = {"": "Object;r>,g>,b>",
  ...
  setHex$1: function(hex) {
    var t1, t2;
    t1 = $.toInt($.CONSTANT7.floor$0(hex));
    t2 = $.getInterceptor$JSNumber(t1);
    ...
    if (this._isEmpty) {
      ...
      if (x1 < x2)
        if (x1 < x3) {
          t1 = this._left;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(6, x1, y1, x2, y2, x3, y3, $.CONSTANT7, null, null, null, t1);
          if (x1 < t1)
            t1 = x1;
        } else {
          t1 = this._left;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(8, x1, y1, x2, y2, x3, y3, $.CONSTANT7, null, null, null, t1);
          if (x3 < t1)
            t1 = x3;
        }
      else if (x2 < x3) {
        t1 = this._left;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(10, x1, y1, x2, y2, x3, y3, $.CONSTANT7, t1, null, null, $.CONSTANT7);
        if (x2 < t1)
          t1 = x2;
      } else {
        t1 = this._left;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(12, x1, y1, x2, y2, x3, y3, $.CONSTANT7, null, null, null, t1);
        if (x3 < t1)
          t1 = x3;
      }
      this._left = t1;
      if (y1 < y2)
        if (y1 < y3) {
          t1 = this._top;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(14, x1, y1, x2, y2, x3, y3, $.CONSTANT7, t1, null, null, $.CONSTANT7);
          if (y1 < t1)
            t1 = y1;
        } else {
          t1 = this._top;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(16, x1, y1, x2, y2, x3, y3, $.CONSTANT7, t1, null, null, $.CONSTANT7);
          if (y3 < t1)
            t1 = y3;
        }
      else if (y2 < y3) {
        t1 = this._top;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(18, x1, y1, x2, y2, x3, y3, $.CONSTANT7, $.CONSTANT7, null, null, $.CONSTANT7, t1);
        if (y2 < t1)
          t1 = y2;
      } else {
        t1 = this._top;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(20, x1, y1, x2, y2, x3, y3, $.CONSTANT7, t1, null, null, $.CONSTANT7);
        if (y3 < t1)
          t1 = y3;
      }
      this._top = t1;
      if (x1 > x2)
        if (x1 > x3) {
          t1 = this._right;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(22, x1, y1, null, y2, null, y3, $.CONSTANT7, t1, null, null, $.CONSTANT7);
          if (x1 > t1)
            t1 = x1;
        } else {
          t1 = this._right;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(24, null, y1, null, y2, x3, y3, t1, null, null, null, $.CONSTANT7);
          if (x3 > t1)
            t1 = x3;
        }
      else if (x2 > x3) {
        t1 = this._right;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(26, null, y1, x2, y2, null, y3, $.CONSTANT7, t1, null, null, $.CONSTANT7);
        if (x2 > t1)
          t1 = x2;
      } else {
        t1 = this._right;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(28, null, y1, null, y2, x3, y3, t1, null, null, null, $.CONSTANT7);
        if (x3 > t1)
          t1 = x3;
      }
      this._right = t1;
      if (y1 > y2)
        if (y1 > y3) {
          t1 = this._bottom;
          if (typeof t1 !== "number")
            return this.add3Points$6$bailout(30, null, y1, null, null, null, null, t1, null, null, null, $.CONSTANT7);
          if (y1 > t1)
            t1 = y1;
        } else {
          t1 = this._bottom;
        ...
        t1 = this._bottom;
        if (typeof t1 !== "number")
          return this.add3Points$6$bailout(34, null, null, null, y2, null, null, $.CONSTANT7, null, null, null, t1);
        if (y2 > t1)
          t1 = y2;
      } else {
        t1 = this._bottom;
...
$$.Material = {"": "Object;id=,side>,opacity>,blending>,overdraw>,visible=,needsUpdate=",
  get$_data: function() {
    if (this.__data == null)
      this.__data = $.makeLiteralMap([]);
    return this.__data;
  ...
  $index: function(key) {
    var t1 = this.get$_data();
    if (typeof t1 !== "string" && (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !t1.$isJavaScriptIndexingBehavior()))
      return this.$$index$bailout4(1, key, t1);
    if (key !== (key | 0))
      throw $.iae(key);
    if (key < 0 || key >= t1.length)
      throw $.ioore(key);
  ...
  $$index$bailout4: function(state0, key, t1) {
    return $.$$index(t1, key);
  },
  $indexSet: function(key, value) {
    var t1 = this.get$_data();
...
$$.CanvasRenderer = {"": "Object;domElement>,_autoClear,_sortObjects,_sortElements,_canvasWidth,_canvasHeight,_canvasWidthHalf,_canvasHeightHalf,_clearColor,_clearOpacity,_camera,_canvas,_context,_contextGlobalAlpha,_contextGlobalCompositeOperation,_contextStrokeStyle,_contextFillStyle,_contextLineCap,_contextLineJoin,_contextLineWidth,_clipRect,_clearRect,_bboxRect,_info,_renderData>,_elements,_lights,_projector,_v5,_v6,_v1x,_v1y,_v2x,_v2y,_v3x,_v3y,_v4x,_v4y,_v5x,_v5y,_v6x,_v6y,_color,_color1,_color2,_color3,_color4,_patterns,_imagedatas,_near,_far,_image,_uvs,_uv1x,_uv1y,_uv2x,_uv2y,_uv3x,_uv3y,_enableLighting,_ambientLight,_directionalLights,_pointLights,_pi2,_vector3,_pixelMapImage,_pixelMapData,_gradientMapQuality,_pixelMap,_pixelMapContext,_gradientMap,_gradientMapContext,debug",
  ...
  calculateLight$4: function(lights, position, normal, color) {
    var ll, amount, l, lightPosition, light, lightColor, t1, t2;
    if (typeof lights !== "string" && (typeof lights !== "object" || lights === null || lights.constructor !== Array && !lights.$isJavaScriptIndexingBehavior()))
      return this.calculateLight$4$bailout(1, lights, position, normal, color);
    ll = lights.length;
    for (amount = null, l = 0, lightPosition = null; l < ll; ++l) {
      if (l >= lights.length)
        throw $.ioore(l);
      light = lights[l];
      lightColor = light.get$color();
  ...
  calculateLight$4$bailout: function(state0, lights, position, normal, color, t1, ll) {
    switch (state0) {
      ...
      case 1:
        ...
        ll = t1.get$length(lights);
      case 2:
        var amount, l, lightPosition, light, lightColor, t2, t3;
        state0 = 0;
        for (amount = null, l = 0, lightPosition = null; $.CONSTANT6.$lt(l, ll); ++l) {
          light = t1.$index(lights, l);
          lightColor = light.get$color();
          if (typeof light === "object" && light !== null && !!light.$isDirectionalLight) {
            lightPosition = light.matrixWorld.getPosition$0();
  ...
  renderParticle$4: function(v1, element, material, scene) {
    ...
    if (typeof material === "object" && material !== null && !!material.$isParticleBasicMaterial) {
      ...
      if (t1 === true) {
        ...
        t13 = v1.x;
        if (typeof t13 !== "number")
          return this.renderParticle$4$bailout(7, v1, element, bitmap, t1, t3, t5, null, t8, t10, $.CONSTANT7, height, t12, t13);
        t15 = t13 - t5;
        t16 = v1.y;
        if (typeof t16 !== "number")
          return this.renderParticle$4$bailout(8, v1, element, bitmap, t1, t3, t5, null, t8, t10, $.CONSTANT7, height, t12, t15, t16);
        ...
        t4 = element.rotation;
        if (typeof t4 !== "number")
          return this.renderParticle$4$bailout(11, v1, null, bitmap, t1, t3, null, null, t8, t10, $.CONSTANT7, null, null, null, null, null, t2, t4);
        t2.rotate$1(-t4);
      ...
      t3 = element.rotation;
      if (typeof t3 !== "number")
        return this.renderParticle$4$bailout(24, null, null, null, null, t3, null, t6, null, null, null, null, null, null, null, null, t2, t4, null, null, material);
      t2.rotate$1(-t3);
  ...
  renderFace3$9: function(v1, v2, v3, uv1, uv2, uv3, element, material, scene) {
    var t1, t2, t4, t5, t6, t7, t8, t9, t10, t12, t13, t14, t15, t16, cameraMatrix, t3, t18, t20, t24, t27, t29, t32, t33, t36, t40, t43, t45, t48, t50, t54, t57, t59, t62, t63, t66, t70, t73, t75, t78, t80, t84, t87, t89, t22, t26, t28, t30, t34, t38, t41, t47, t49, t51, t53, t11;
    ...
    if (typeof material === "object" && material !== null && !!material.$isMeshBasicMaterial) {
      ...
      if (this._enableLighting === true) {
        ...
        if (t2) {
          ...
          t4 = element.get$vertexNormalsWorld();
          if (typeof t4 !== "string" && (typeof t4 !== "object" || t4 === null || t4.constructor !== Array && !t4.$isJavaScriptIndexingBehavior()))
            return this.renderFace3$9$bailout(76, null, null, null, null, null, null, element, null, t1, t2, t4, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3);
          if (0 >= t4.length)
            throw $.ioore(0);
          this.calculateLight$4(t1, t2, t4[0], this._color1);
          t2 = this._lights;
          t1 = element.get$v2().get$positionWorld();
          t6 = element.get$vertexNormalsWorld();
          if (typeof t6 !== "string" && (typeof t6 !== "object" || t6 === null || t6.constructor !== Array && !t6.$isJavaScriptIndexingBehavior()))
            return this.renderFace3$9$bailout(77, null, null, null, null, null, null, element, null, t1, t2, null, null, null, null, null, null, t6, null, null, null, null, null, null, null, null, null, null, null, t3);
          if (1 >= t6.length)
            throw $.ioore(1);
          this.calculateLight$4(t2, t1, t6[1], this._color2);
          t1 = this._lights;
          ...
          if (typeof t8 !== "string" && (typeof t8 !== "object" || t8 === null || t8.constructor !== Array && !t8.$isJavaScriptIndexingBehavior()))
            return this.renderFace3$9$bailout(78, null, null, null, null, null, null, null, null, t1, t2, null, null, t8, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3);
          if (2 >= t8.length)
            throw $.ioore(2);
          this.calculateLight$4(t1, t2, t8[2], this._color3);
          t2 = t3.get$r();
          t10 = this._color1.r;
          if (typeof t2 !== "number")
            return this.renderFace3$9$bailout(79, null, null, null, null, null, null, null, null, null, t2, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3);
          if (typeof t10 !== "number")
            return this.renderFace3$9$bailout(80, null, null, null, null, null, null, null, null, null, t2, null, null, null, null, t10, null, null, null, null, null, null, null, null, null, null, null, null, null, t3);
          t12 = $.max(0, $.min(t2 * t10, 1));
          this._color1.r = t12;
          t12 = t3.get$g();
          t14 = this._color1.g;
          if (typeof t12 !== "number")
            return this.renderFace3$9$bailout(81, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t12, null, null, null, null, null, null, null, null, null, t3);
          if (typeof t14 !== "number")
            return this.renderFace3$9$bailout(82, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t12, null, null, null, null, null, null, null, null, null, t3, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t14);
          t16 = $.max(0, $.min(t12 * t14, 1));
          this._color1.g = t16;
          t16 = t3.get$b();
          t18 = this._color1.b;
          if (typeof t16 !== "number")
            return this.renderFace3$9$bailout(83, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t16, null, null, null, null, null, null, null, null, t3);
          if (typeof t18 !== "number")
            return this.renderFace3$9$bailout(84, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t16, null, null, t18, null, null, null, null, null, t3);
          t20 = $.max(0, $.min(t16 * t18, 1));
          this._color1.b = t20;
          t20 = t3.get$r();
          t22 = this._color2.r;
          if (typeof t20 !== "number")
            return this.renderFace3$9$bailout(85, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3, t20);
          if (typeof t22 !== "number")
            return this.renderFace3$9$bailout(86, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t22, null, null, null, t3, t20);
          t24 = $.max(0, $.min(t20 * t22, 1));
          this._color2.r = t24;
          t24 = t3.get$g();
          t26 = this._color2.g;
          if (typeof t24 !== "number")
            return this.renderFace3$9$bailout(87, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t24, null, null, t3);
          if (typeof t26 !== "number")
            return this.renderFace3$9$bailout(88, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t24, null, null, t3, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t26);
          t28 = $.max(0, $.min(t24 * t26, 1));
          this._color2.g = t28;
          t28 = t3.get$b();
          t30 = this._color2.b;
          if (typeof t28 !== "number")
            return this.renderFace3$9$bailout(89, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t28);
          if (typeof t30 !== "number")
            return this.renderFace3$9$bailout(90, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t28, t30);
          t32 = $.max(0, $.min(t28 * t30, 1));
          this._color2.b = t32;
          t32 = t3.get$r();
          t34 = this._color3.r;
          if (typeof t32 !== "number")
            return this.renderFace3$9$bailout(91, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3, null, null, null, null, t32);
          if (typeof t34 !== "number")
            return this.renderFace3$9$bailout(92, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3, null, null, null, null, t32, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t34);
          t36 = $.max(0, $.min(t32 * t34, 1));
          this._color3.r = t36;
          t36 = t3.get$g();
          t38 = this._color3.g;
          if (typeof t36 !== "number")
            return this.renderFace3$9$bailout(93, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3, null, null, null, null, null, t36);
          if (typeof t38 !== "number")
            return this.renderFace3$9$bailout(94, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3, null, null, null, null, null, t36, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t38);
          t40 = $.max(0, $.min(t36 * t38, 1));
          this._color3.g = t40;
          t3 = t3.get$b();
          t41 = this._color3.b;
          if (typeof t3 !== "number")
            return this.renderFace3$9$bailout(95, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3);
          if (typeof t41 !== "number")
            return this.renderFace3$9$bailout(96, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t41);
          t43 = $.max(0, $.min(t3 * t41, 1));
          this._color3.b = t43;
          t43 = this._color2.r;
          t45 = this._color3.r;
          if (typeof t43 !== "number")
          ...
          if (typeof t47 !== "number")
            return this.renderFace3$9$bailout(99, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t47);
          if (typeof t49 !== "number")
            return this.renderFace3$9$bailout(100, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t47, t49);
          this._color4.g = (t47 + t49) * 0.5;
          t51 = this._color2.b;
          t53 = this._color3.b;
          if (typeof t51 !== "number")
            return this.renderFace3$9$bailout(101, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t51);
          if (typeof t53 !== "number")
            return this.renderFace3$9$bailout(102, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t51, t53);
          ...
          t5 = this._color.r;
          if (typeof t2 !== "number")
            return this.renderFace3$9$bailout(103, null, null, null, null, null, null, null, material, t1, t2, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3);
          if (typeof t5 !== "number")
            return this.renderFace3$9$bailout(104, null, null, null, null, null, null, null, material, t1, t2, null, null, null, null, null, t5, null, null, null, null, null, null, null, null, null, null, null, null, t3);
          t7 = $.max(0, $.min(t2 * t5, 1));
          this._color.r = t7;
          t7 = t3.get$g();
          t9 = this._color.g;
          if (typeof t7 !== "number")
            return this.renderFace3$9$bailout(105, null, null, null, null, null, null, null, material, t1, null, null, t7, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3);
          if (typeof t9 !== "number")
            return this.renderFace3$9$bailout(106, null, null, null, null, null, null, null, material, t1, null, null, t7, null, t9, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3);
          t11 = $.max(0, $.min(t7 * t9, 1));
          this._color.g = t11;
          t3 = t3.get$b();
          t12 = this._color.b;
          if (typeof t3 !== "number")
            return this.renderFace3$9$bailout(107, null, null, null, null, null, null, null, material, t1, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t3);
          if (typeof t12 !== "number")
            return this.renderFace3$9$bailout(108, null, null, null, null, null, null, null, material, t1, null, null, null, null, null, null, null, null, null, t12, null, null, null, null, null, null, null, null, null, t3);
          t14 = $.max(0, $.min(t3 * t12, 1));
          this._color.b = t14;
          t2 = this._color;
          if (t1)
            this.strokePath$4(t2, material.wireframeLinewidth, material.wireframeLinecap, material.wireframeLinejoin);
      ...
      if (typeof t11 !== "number")
        return this.renderFace3$9$bailout(114, null, null, null, null, null, null, null, null, null, null, null, null, null, t9, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t11);
                        ...
                        case 108:
                          if (state0 === 102 || state0 === 101 || state0 === 100 || state0 === 99 || state0 === 98 || state0 === 97 || state0 === 96 || state0 === 95 || state0 === 94 || state0 === 93 || state0 === 92 || state0 === 91 || state0 === 90 || state0 === 89 || state0 === 88 || state0 === 87 || state0 === 86 || state0 === 85 || state0 === 84 || state0 === 83 || state0 === 82 || state0 === 81 || state0 === 80 || state0 === 79 || state0 === 78 || state0 === 77 || state0 === 76 || state0 === 0 && t2)
                            switch (state0) {
                              ...
                              case 76:
                                state0 = 0;
                                this.calculateLight$4(t1, t2, $.$$index(t4, 0), this._color1);
                                t2 = this._lights;
                                t1 = element.get$v2().get$positionWorld();
                                t6 = element.get$vertexNormalsWorld();
                              case 77:
                                state0 = 0;
                                this.calculateLight$4(t2, t1, $.$$index(t6, 1), this._color2);
                                t1 = this._lights;
                                t2 = element.get$v3().get$positionWorld();
                                t8 = element.get$vertexNormalsWorld();
                              case 78:
                                state0 = 0;
                                this.calculateLight$4(t1, t2, $.$$index(t8, 2), this._color3);
                                t2 = t3.get$r();
                              case 79:
                                state0 = 0;
                                t10 = this._color1.r;
  ...
  renderFace4$9: function(v1, v2, v3, v4, v5, v6, element, material, scene) {
    var t1, t2, t4, t3, t5, t7, t9, t11, t13, t15, t17, t19, t21, t23, t25, t27, t29, t31, t33, t35, t37, t39, t41, t43, t45, t47, t48, t50, t12, t14;
    t1 = this._info.render;
    t2 = t1.vertices;
    if (typeof t2 !== "number")
    ...
    if (typeof material === "object" && material !== null && !!material.$isMeshBasicMaterial) {
      ...
      if (this._enableLighting === true) {
        ...
        if (t2) {
          ...
          t5 = this._color1.r;
          if (typeof t1 !== "number")
            return this.renderFace4$9$bailout(4, null, null, null, null, null, null, null, null, null, null, t1, t4);
          if (typeof t5 !== "number")
            return this.renderFace4$9$bailout(5, null, null, null, null, null, null, null, null, null, null, t1, t4, t5);
          t7 = $.max(0, $.min(t1 * t5, 1));
          this._color1.r = t7;
          t7 = t4.get$g();
          t9 = this._color1.g;
          if (typeof t7 !== "number")
            return this.renderFace4$9$bailout(6, null, null, null, null, null, null, null, null, null, null, null, t4, null, t7);
          if (typeof t9 !== "number")
            return this.renderFace4$9$bailout(7, null, null, null, null, null, null, null, null, null, null, null, t4, null, t7, t9);
          t11 = $.max(0, $.min(t7 * t9, 1));
          this._color1.g = t11;
          t11 = t4.get$b();
          t13 = this._color1.b;
          if (typeof t11 !== "number")
            return this.renderFace4$9$bailout(8, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, t11);
          if (typeof t13 !== "number")
            return this.renderFace4$9$bailout(9, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, t11, t13);
          t15 = $.max(0, $.min(t11 * t13, 1));
          this._color1.b = t15;
          t15 = t4.get$r();
          t17 = this._color2.r;
          if (typeof t15 !== "number")
            return this.renderFace4$9$bailout(10, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, t15);
          if (typeof t17 !== "number")
            return this.renderFace4$9$bailout(11, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, t15, t17);
          t19 = $.max(0, $.min(t15 * t17, 1));
          this._color2.r = t19;
          t19 = t4.get$g();
          t21 = this._color2.g;
          if (typeof t19 !== "number")
            return this.renderFace4$9$bailout(12, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, t19);
          if (typeof t21 !== "number")
            return this.renderFace4$9$bailout(13, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, t19, t21);
          t23 = $.max(0, $.min(t19 * t21, 1));
          this._color2.g = t23;
          t23 = t4.get$b();
          t25 = this._color2.b;
          if (typeof t23 !== "number")
            return this.renderFace4$9$bailout(14, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, t23);
          if (typeof t25 !== "number")
            return this.renderFace4$9$bailout(15, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, t23, t25);
          t27 = $.max(0, $.min(t23 * t25, 1));
          this._color2.b = t27;
          t27 = t4.get$r();
          t29 = this._color3.r;
          if (typeof t27 !== "number")
            return this.renderFace4$9$bailout(16, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, null, null, t27);
          if (typeof t29 !== "number")
            return this.renderFace4$9$bailout(17, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, null, null, t27, t29);
          t31 = $.max(0, $.min(t27 * t29, 1));
          this._color3.r = t31;
          t31 = t4.get$g();
          t33 = this._color3.g;
          if (typeof t31 !== "number")
            return this.renderFace4$9$bailout(18, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, null, null, null, null, t31);
          if (typeof t33 !== "number")
            return this.renderFace4$9$bailout(19, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, null, null, null, null, t31, t33);
          t35 = $.max(0, $.min(t31 * t33, 1));
          this._color3.g = t35;
          t35 = t4.get$b();
          t37 = this._color3.b;
          if (typeof t35 !== "number")
            return this.renderFace4$9$bailout(20, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t35);
          if (typeof t37 !== "number")
            return this.renderFace4$9$bailout(21, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t35, t37);
          t39 = $.max(0, $.min(t35 * t37, 1));
          this._color3.b = t39;
          t39 = t4.get$r();
          t41 = this._color4.r;
          if (typeof t39 !== "number")
            return this.renderFace4$9$bailout(22, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t39);
          if (typeof t41 !== "number")
            return this.renderFace4$9$bailout(23, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t39, t41);
          t43 = $.max(0, $.min(t39 * t41, 1));
          this._color4.r = t43;
          t43 = t4.get$g();
          t45 = this._color4.g;
          if (typeof t43 !== "number")
            return this.renderFace4$9$bailout(24, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t43);
          if (typeof t45 !== "number")
            return this.renderFace4$9$bailout(25, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t43, t45);
          t47 = $.max(0, $.min(t43 * t45, 1));
          this._color4.g = t47;
          t4 = t4.get$b();
          t48 = this._color4.b;
          if (typeof t4 !== "number")
            return this.renderFace4$9$bailout(26, null, null, null, null, null, null, null, null, null, null, null, t4);
          if (typeof t48 !== "number")
            return this.renderFace4$9$bailout(27, null, null, null, null, null, null, null, null, null, null, null, t4, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t48);
          t50 = $.max(0, $.min(t4 * t48, 1));
          this._color4.b = t50;
          this._image = this.getGradientTexture$4(this._color1, this._color2, this._color3, this._color4);
          ...
          t5 = this._color.r;
          if (typeof t2 !== "number")
            return this.renderFace4$9$bailout(28, null, null, null, null, null, null, null, material, null, t2, t1, t4);
          if (typeof t5 !== "number")
            return this.renderFace4$9$bailout(29, null, null, null, null, null, null, null, material, null, t2, t1, t4, t5);
          t7 = $.max(0, $.min(t2 * t5, 1));
          this._color.r = t7;
          t7 = t4.get$g();
          t9 = this._color.g;
          if (typeof t7 !== "number")
            return this.renderFace4$9$bailout(30, null, null, null, null, null, null, null, material, null, null, t1, t4, null, t7);
          if (typeof t9 !== "number")
            return this.renderFace4$9$bailout(31, null, null, null, null, null, null, null, material, null, null, t1, t4, null, t7, t9);
          t11 = $.max(0, $.min(t7 * t9, 1));
          this._color.g = t11;
          t4 = t4.get$b();
          t12 = this._color.b;
          if (typeof t4 !== "number")
            return this.renderFace4$9$bailout(32, null, null, null, null, null, null, null, material, null, null, t1, t4);
          if (typeof t12 !== "number")
            return this.renderFace4$9$bailout(33, null, null, null, null, null, null, null, material, null, null, t1, t4, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t12);
          t14 = $.max(0, $.min(t4 * t12, 1));
          this._color.b = t14;
          this.drawQuad$8(this._v1x, this._v1y, this._v2x, this._v2y, this._v3x, this._v3y, this._v4x, this._v4y);
          t2 = this._color;
          if (t1)
  ...
  renderFace4$9$bailout: function(state0, v1, v2, v3, v4, v5, v6, element, material, scene, t2, t1, t4, t5, t7, t9, t11, t13, t15, t17, t19, t21, t23, t25, t27, t29, t31, t33, t35, t37, t39, t41, t43, t45, t48, t12) {
    switch (state0) {
      case 0:
        t1 = this._info.render;
        t2 = t1.vertices;
...
$$.Scene = {"": "Object3D;fog,overrideMaterial,objects=,lights=,__objectsAdded,__objectsRemoved,id,name,properties,parent,children,up,position,rotation,scale,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth,matrix,matrixWorld,matrixRotationWorld,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible,castShadow,receiveShadow,frustumCulled,_vector,__data",
  addObject$1: function(object) {
    ...
    if (typeof object === "object" && object !== null && !!object.$isLight) {
      ...
      t1 = $.indexOf(this.objects, object);
      if (typeof t1 !== "number")
        return this.addObject$1$bailout(2, object, t1);
      if (t1 === -1) {
        $.add(this.objects, object);
        this.__objectsAdded.push(object);
        i = $.CONSTANT8.indexOf$1(this.__objectsRemoved, object);
        if (typeof i !== "number")
          return this.addObject$1$bailout(3, object, null, i);
        if (!(i === -1))
          $.CONSTANT8.removeRange$2(this.__objectsRemoved, i, 1);
      }
    }
    c = 0;
    while (true) {
  ...
  removeObject$1: function(object) {
    ...
    if (typeof object === "object" && object !== null && !!object.$isLight) {
      ...
      if (!(t1 === -1)) {
        ...
        ai = $.CONSTANT8.indexOf$1(this.__objectsAdded, object);
        if (typeof ai !== "number")
          return this.removeObject$1$bailout(3, object, null, ai);
        if (!(ai === -1))
          $.CONSTANT8.removeRange$2(this.__objectsAdded, ai, 1);
      }
    }
    c = 0;
    while (true) {
...
$$.FirstPersonControls = {"": "Object;object=,target,domElement>,movementSpeed<,lookSpeed,lookVertical,autoForward,activeLook,heightSpeed,heightCoef,heightMin,heightMax,constrainVertical,verticalMin,verticalMax,autoSpeedFactor,mouseX,mouseY,lat,lon,phi,theta,moveForward,moveBackward,moveLeft,moveRight,moveUp,moveDown,freeze,mouseDragOn,viewHalfX,viewHalfY",
  handleResize$0: function() {
    if ($.$$eq(this.domElement, document) === true) {
      this.viewHalfX = $.$$div(window.get$innerWidth(), 2);
      this.viewHalfY = $.$$div(window.get$innerHeight(), 2);
    } else {
      this.viewHalfX = $.$$div(this.domElement.get$offsetWidth(), 2);
      this.viewHalfY = $.$$div(this.domElement.get$offsetHeight(), 2);
    }
  },
  onMouseDown$1: function(event) {
    if ($.$$eq(this.domElement, document) !== true)
      this.domElement.focus$0();
    event.preventDefault$0();
    event.stopPropagation$0();
    if (this.activeLook)
      switch (event.get$button()) {
        case 0:
  ...
  get$onMouseDown: function() {
    return new $.BoundClosure(this, "onMouseDown$1");
  },
  ...
  get$onMouseUp: function() {
    return new $.BoundClosure(this, "onMouseUp$1");
  },
  onMouseMove$1: function(event) {
    var t1, t2;
    t1 = $.$$eq(this.domElement, document);
    t2 = event.get$pageX();
    if (t1 === true) {
      this.mouseX = $.$$sub(t2, this.viewHalfX);
      this.mouseY = $.$$sub(event.get$pageY(), this.viewHalfY);
    } else {
      this.mouseX = $.$$sub($.$$sub(t2, this.domElement.get$offsetLeft()), this.viewHalfX);
      this.mouseY = $.$$sub($.$$sub(event.get$pageY(), this.domElement.get$offsetTop()), this.viewHalfY);
    }
  },
  get$onMouseMove: function() {
    return new $.BoundClosure(this, "onMouseMove$1");
  },
  ...
  update$1: function(delta) {
    var t1, y, t2, t3, y0, actualMoveSpeed, actualLookSpeed, targetPosition, position, verticalLookRatio, t4;
    if (this.freeze)
      return;
    else {
      if (this.heightSpeed) {
        t1 = this.object.get$position().get$y();
        y = this.heightMin;
        t2 = this.heightMax;
        ...
        if (t3.$lt(t1, y) === true)
          ...
          y0 = t3.$gt(t1, t2) === true ? t2 : t1;
        t1 = $.$$mul($.$$sub(y0, y), this.heightCoef);
        if (typeof t1 !== "number")
          throw $.iae(t1);
        this.autoSpeedFactor = delta * t1;
      } else
        this.autoSpeedFactor = 0;
      t1 = this.movementSpeed;
      if (typeof t1 !== "number")
        throw $.iae(t1);
      actualMoveSpeed = delta * t1;
      if (!this.moveForward)
        t1 = this.autoForward && !this.moveBackward;
      else
        t1 = true;
      if (t1)
        this.object.translateZ$1(-(actualMoveSpeed + this.autoSpeedFactor));
      if (this.moveBackward)
        this.object.translateZ$1(actualMoveSpeed);
      if (this.moveLeft)
        this.object.translateX$1(-actualMoveSpeed);
      if (this.moveRight)
        this.object.translateX$1(actualMoveSpeed);
      if (this.moveUp)
        this.object.translateY$1(actualMoveSpeed);
      if (this.moveDown)
        this.object.translateY$1(-actualMoveSpeed);
      ...
      if (!this.activeLook)
        actualLookSpeed = 0;
      t1 = this.lon;
      t2 = $.$$mul(this.mouseX, actualLookSpeed);
      if (typeof t2 !== "number")
        throw $.iae(t2);
      this.lon = t1 + t2;
      t1 = this.lookVertical;
      if (t1)
        this.lat = $.$$sub(this.lat, $.$$mul(this.mouseY, actualLookSpeed));
      this.lat = $.max(-85, $.min(85, this.lat));
      t2 = this.lat;
      if (typeof t2 !== "number")
        throw $.iae(t2);
      this.phi = (90 - t2) * 3.141592653589793 / 180;
      this.theta = this.lon * 3.141592653589793 / 180;
      targetPosition = this.target;
      position = this.object.get$position();
      targetPosition.x = $.$$add(position.get$x(), 100 * Math.sin($.checkNum(this.phi)) * Math.cos($.checkNum(this.theta)));
      targetPosition.y = $.$$add(position.get$y(), 100 * Math.cos($.checkNum(this.phi)));
      targetPosition.z = $.$$add(position.get$z(), 100 * Math.sin($.checkNum(this.phi)) * Math.sin($.checkNum(this.theta)));
    }
    t2 = this.constrainVertical;
    verticalLookRatio = t2 ? 3.141592653589793 / (this.verticalMax - this.verticalMin) : 1;
    t3 = this.lon;
    t4 = $.$$mul(this.mouseX, 0);
    if (typeof t4 !== "number")
      throw $.iae(t4);
    this.lon = t3 + t4;
    if (t1)
      this.lat = $.$$sub(this.lat, $.$$mul($.$$mul(this.mouseY, 0), verticalLookRatio));
    this.lat = $.max(-85, $.min(85, this.lat));
    t1 = this.lat;
    if (typeof t1 !== "number")
      throw $.iae(t1);
    this.phi = (90 - t1) * 3.141592653589793 / 180;
    this.theta = this.lon * 3.141592653589793 / 180;
    if (t2) {
      t1 = this.phi;
      t2 = this.verticalMin;
      this.phi = t2 + (t1 - 0) * (this.verticalMax - t2) / 3.141592653589793;
    }
    position = this.object.get$position();
    targetPosition.x = $.$$add(position.get$x(), 100 * Math.sin($.checkNum(this.phi)) * Math.cos($.checkNum(this.theta)));
    targetPosition.y = $.$$add(position.get$y(), 100 * Math.cos($.checkNum(this.phi)));
    targetPosition.z = $.$$add(position.get$z(), 100 * Math.sin($.checkNum(this.phi)) * Math.sin($.checkNum(this.theta)));
    this.object.lookAt$1(targetPosition);
  },
  FirstPersonControls$2: function(object, domElement, domElement_check) {
    this.domElement = domElement_check === true ? domElement : $.document();
    if ($.$$eq(this.domElement, $.document()) !== true)
      this.domElement.set$tabIndex(-1);
    this.domElement.get$onContextMenu().listen$1(new $.anon());
    this.domElement.get$onMouseMove().listen$1(this.get$onMouseMove());
    this.domElement.get$onMouseDown().listen$1(this.get$onMouseDown());
    this.domElement.get$onMouseUp().listen$1(this.get$onMouseUp());
    this.domElement.get$onKeyDown().listen$1(this.get$onKeyDown());
    this.domElement.get$onKeyUp().listen$1(this.get$onKeyUp());
    this.handleResize$0();
  }
};
...
$$.convertNativeToDart_AcceptStructuredClone_walk = {"": "Closure;mustCopy_4,findSlot_5,readSlot_6,writeSlot_7",
  call$1: function(e) {
    ...
    if (Object.getPrototypeOf(e) === Object.prototype) {
      ...
      for (t1 = $.CONSTANT8.get$iterator(Object.keys(e)); t1.moveNext$0() === true;) {
        t2 = t1.get$current();
        t3 = this.call$1(e[t2]);
        if (t2 !== (t2 | 0))
          throw $.iae(t2);
    ...
    if (e instanceof Array) {
      ...
      if (this.mustCopy_4 === true)
        ...
        copy = e;
      if (typeof copy !== "object" || copy === null || (copy.constructor !== Array || !!copy.immutable$list) && !copy.$isJavaScriptIndexingBehavior())
        return this.call$1$bailout(4, e, copy, slot, length, $.CONSTANT8);
      this.writeSlot_7.call$2(slot, copy);
      for (i = 0; i < length; ++i) {
        if (i >= e.length)
          throw $.ioore(i);
        ...
        if (state0 === 2 || state0 === 0 && Object.getPrototypeOf(e) === Object.prototype)
          switch (state0) {
            ...
            case 2:
              state0 = 0;
              this.writeSlot_7.call$2(slot, copy);
              for (t1 = $.CONSTANT8.get$iterator(Object.keys(e)), t2 = $.getInterceptor$JSArray(copy); t1.moveNext$0() === true;) {
                t3 = t1.get$current();
...
$.unwrapException = function(ex) {
  ...
  if (ex instanceof TypeError) {
    ...
    if (t1)
      if ($.CONSTANT10.endsWith$1(message, "is null") === true || $.CONSTANT10.endsWith$1(message, "is undefined") === true || $.CONSTANT10.endsWith$1(message, "is null or undefined") === true || $.CONSTANT10.endsWith$1(message, "of undefined") === true || $.CONSTANT10.endsWith$1(message, "of null") === true)
...
$.makeLiteralMap = function(keyValuePairs) {
  ...
  iterator = $.CONSTANT8.get$iterator(keyValuePairs);
...
$.stringContainsUnchecked = function(receiver, other, startIndex) {
  if (typeof other === "string")
    return $.$$eq($.CONSTANT10.indexOf$2(receiver, other, startIndex), -1) !== true;
  else if (typeof other === "object" && other !== null && !!other.$isJSSyntaxRegExp)
    return other.hasMatch$1($.CONSTANT10.substring$1(receiver, startIndex));
  else
    return $.iterator($.allMatches(other, $.CONSTANT10.substring$1(receiver, startIndex))).moveNext$0();
};
...
$.Arrays_copy$bailout = function(state0, src, srcStart, dst, dstStart, count) {
  ...
  if (srcStart < dstStart)
    for (i = srcStart + count - 1, j = dstStart + count - 1; i >= srcStart; --i, --j) {
      if (i < 0 || i >= src.length)
        throw $.ioore(i);
      $.CONSTANT8.$indexSet(dst, j, src[i]);
    }
  else
...
$.IterableMixinWorkaround_removeAll = function(collection, elementsToRemove) {
  var t1, t2;
  for (t1 = $.CONSTANT8.get$iterator(elementsToRemove), t2 = $.getInterceptor$JSArray(collection); t1.moveNext$0() === true;)
    t2.remove$1(collection, t1.get$current());
};

$.IterableMixinWorkaround_removeAllList = function(collection, elementsToRemove) {
  $.removeMatching(collection, $.contains($.CONSTANT8.toSet$0(elementsToRemove)));
};
...
$.IterableMixinWorkaround_removeMatchingList$bailout = function(state0, list, test) {
  ...
  for (i = 0; t1 = retained.length, i < t1; ++i)
    $.CONSTANT8.$indexSet(list, i, retained[i]);
  $.CONSTANT8.set$length(list, t1);
};
...
$._HashSetIterator$ = function(set) {
  return new $._HashSetIterator($.CONSTANT8.get$iterator(set._backingMap._keys));
};
...
$._Sort_insertionSort_$bailout = function(state0, a, left, right, compare) {
  ...
  for (i = left + 1; i <= right; ++i) {
    ...
    while (true) {
      ...
      if (j0 < 0 || j0 >= a.length)
        throw $.ioore(j0);
      $.CONSTANT8.$indexSet(a, j, a[j0]);
      j = j0;
    }
    $.CONSTANT8.$indexSet(a, j, el);
  }
};
...
$._Sort__dualPivotQuicksort = function(a, left, right, compare) {
  ...
  index1 = left + sixth;
  index5 = right - sixth;
  index3 = $.CONSTANT6.$tdiv(left + right, 2);
  index2 = index3 - sixth;
  index4 = index3 + sixth;
  t1 = a.length;
...
$._Sort__dualPivotQuicksort$bailout = function(state0, a, left, right, compare) {
  ...
  $.CONSTANT8.$indexSet(a, index1, el1);
  $.CONSTANT8.$indexSet(a, index3, el3);
  $.CONSTANT8.$indexSet(a, index5, el5);
  if (left < 0 || left >= a.length)
    throw $.ioore(left);
  $.CONSTANT8.$indexSet(a, index2, a[left]);
  if (right < 0 || right >= a.length)
    throw $.ioore(right);
  $.CONSTANT8.$indexSet(a, index4, a[right]);
  less = left + 1;
  great = right - 1;
  t1 = $.$$eq(compare.call$2(el2, el4), 0) === true;
  if (t1)
    for (k = less; k <= great; ++k) {
      ...
      if (t2.$lt(comp, 0) === true) {
        if (k !== less) {
          if (less >= a.length)
            throw $.ioore(less);
          $.CONSTANT8.$indexSet(a, k, a[less]);
          $.CONSTANT8.$indexSet(a, less, ak);
        }
        ++less;
      } else
        for (; true;) {
          ...
          if (t2.$gt(comp, 0) === true) {
            ...
            if (t2 === true) {
              ...
              if (great >= a.length)
                throw $.ioore(great);
              $.CONSTANT8.$indexSet(a, less, a[great]);
              $.CONSTANT8.$indexSet(a, great, ak);
              great = great0;
              less = less0;
              break;
            } else {
              if (great >= t3)
                throw $.ioore(great);
              $.CONSTANT8.$indexSet(a, k, a[great]);
              $.CONSTANT8.$indexSet(a, great, ak);
              great = great0;
              break;
            }
  ...
  if (t2 >= a.length)
    throw $.ioore(t2);
  $.CONSTANT8.$indexSet(a, left, a[t2]);
  $.CONSTANT8.$indexSet(a, t2, el2);
  t2 = great + 1;
  if (t2 < 0 || t2 >= a.length)
    throw $.ioore(t2);
  $.CONSTANT8.$indexSet(a, right, a[t2]);
  $.CONSTANT8.$indexSet(a, t2, el4);
  $._Sort__doSort(a, left, less - 2, compare);
  $._Sort__doSort(a, great + 2, right, compare);
  if (t1)
    return;
...
$.Error_safeToString = function(object) {
  ...
  if (typeof object === "string")
    return "\"" + $.S($.replaceAll($.replaceAll($.replaceAll($.CONSTANT10.replaceAll$2(object, "\\", "\\\\"), "\n", "\\n"), "\r", "\\r"), "\"", "\\\"")) + "\"";
...
$.List_List$fixedLength$bailout = function(state0, length, fill, result) {
  var t1, i;
  if ($.$$eq(length, 0) !== true && !(fill == null))
    for (t1 = $.getInterceptor$JSStringJSArray(result), i = 0; $.CONSTANT6.$lt(i, t1.get$length(result)); ++i)
    ...
    if (typeof b === "number") {
      ...
      if (typeof b === "number") {
        if (typeof a === "number")
          if (a === 0)
            return (a + b) * a * b;
        if (a === 0 && $.CONSTANT11.get$isNegative(b) === true || $.CONSTANT11.get$isNaN(b) === true)
          return b;
        return a;
      }
      return a;
    ...
    if (typeof b === "number") {
      ...
      if (typeof b === "number") {
        if (typeof a === "number")
          if (a === 0)
            return a + b;
        if ($.CONSTANT11.get$isNaN(b) === true)
          return b;
        return a;
      }
...
$.Game$ = function() {
  return new $.Game(null, null, null, null, null, null);
};
...
$.FirstPersonControls$ = function(object, domElement) {
  ...
  if (t1)
    domElement = null;
  t2 = new $.FirstPersonControls(object, $.Vector3$(0, 0, 0), null, 1, 0.005, true, false, true, false, 1, 0, 1, false, 0, 3.141592653589793, 0, 0, 0, 0, 0, 0, 0, false, false, false, false, false, false, false, false, 0, 0);
  t2.FirstPersonControls$2(object, domElement, !t1);
  return t2;
};
...
$.CONSTANT4 = new Isolate.$isolateProperties.EventStreamProvider("mousemove");
$.CONSTANT3 = new Isolate.$isolateProperties.EventStreamProvider("mousedown");
...
$.CONSTANT8 = new Isolate.$isolateProperties.JSArray();
...
$.CONSTANT0 = new Isolate.$isolateProperties.EventStreamProvider("keyup");
$.CONSTANT5 = new Isolate.$isolateProperties.EventStreamProvider("contextmenu");
$.CONSTANT10 = new Isolate.$isolateProperties.JSString();
$.CONSTANT2 = new Isolate.$isolateProperties.EventStreamProvider("mouseup");
$.CONSTANT12 = new Isolate.$isolateProperties._Random();
$.CONSTANT13 = new Isolate.$isolateProperties.Object();
$.CONSTANT9 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CONSTANT1 = new Isolate.$isolateProperties.EventStreamProvider("keydown");
$.lazyPort = null;
...
$._HashMapImpl__DELETED_KEY = Isolate.$isolateProperties.CONSTANT9;
$._HashMapImpl__INITIAL_CAPACITY = 8;
$._Sort__INSERTION_SORT_THRESHOLD = 32;
$._cachedBrowserPrefix = null;
$.Element_contextMenuEvent = Isolate.$isolateProperties.CONSTANT5;
$.Element_keyDownEvent = Isolate.$isolateProperties.CONSTANT1;
$.Element_keyUpEvent = Isolate.$isolateProperties.CONSTANT0;
$.Element_mouseDownEvent = Isolate.$isolateProperties.CONSTANT3;
$.Element_mouseMoveEvent = Isolate.$isolateProperties.CONSTANT4;
$.Element_mouseUpEvent = Isolate.$isolateProperties.CONSTANT2;
$.PI = 3.141592653589793;
$.ElementInstance_contextMenuEvent = Isolate.$isolateProperties.CONSTANT5;
$.ElementInstance_keyDownEvent = Isolate.$isolateProperties.CONSTANT1;
$.ElementInstance_keyUpEvent = Isolate.$isolateProperties.CONSTANT0;
$.ElementInstance_mouseDownEvent = Isolate.$isolateProperties.CONSTANT3;
$.ElementInstance_mouseMoveEvent = Isolate.$isolateProperties.CONSTANT4;
$.ElementInstance_mouseUpEvent = Isolate.$isolateProperties.CONSTANT2;
$.Matrix4____v1 = null;
$.Matrix4____v2 = null;
$.Matrix4____v3 = null;
$.LinePieces = 1;
...
$.$defineNativeClass("Element", {"": "$$dom_children:children~,id=,tabIndex<,$$dom_lastElementChild:lastElementChild~,offsetHeight>,offsetLeft>,offsetTop>,offsetWidth>",
  set$elements: function(value) {
...
$.$defineNativeClass("MouseEvent", {"": "button>,x>,y>"});
...
// 28 !leaf
(function() {
  var v0_MouseEvent = "MouseEvent|WheelEvent", v1_TextPositioningElement = "SVGTextPositioningElement|SVGAltGlyphElement|SVGTRefElement|SVGTextElement|SVGTSpanElement", v2_ComponentTransferFunctionElement = "SVGComponentTransferFunctionElement|SVGFEFuncGElement|SVGFEFuncBElement|SVGFEFuncRElement|SVGFEFuncAElement", v3_MediaElement = "HTMLMediaElement|HTMLVideoElement|HTMLAudioElement", v4_SvgElement = [v1_TextPositioningElement, v2_ComponentTransferFunctionElement, "SVGElement|SVGAElement|SVGAltGlyphDefElement|SVGTextContentElement|SVGTextPathElement|SVGAltGlyphItemElement|SVGAnimationElement|SVGAnimateColorElement|SVGAnimateElement|SVGAnimateMotionElement|SVGAnimateTransformElement|SVGSetElement|SVGCircleElement|SVGClipPathElement|SVGCursorElement|SVGDefsElement|SVGDescElement|SVGEllipseElement|SVGFEBlendElement|SVGFEComponentTransferElement|SVGFECompositeElement|SVGFEDiffuseLightingElement|SVGFEDisplacementMapElement|SVGFEDistantLightElement|SVGFEConvolveMatrixElement|SVGFEFloodElement|SVGFEDropShadowElement|SVGFEGaussianBlurElement|SVGFEColorMatrixElement|SVGFEImageElement|SVGFEPointLightElement|SVGFEMergeElement|SVGFESpecularLightingElement|SVGFEOffsetElement|SVGFilterElement|SVGFETurbulenceElement|SVGFESpotLightElement|SVGFontElement|SVGFontFaceElement|SVGFontFaceFormatElement|SVGFontFaceSrcElement|SVGFEMorphologyElement|SVGFontFaceUriElement|SVGForeignObjectElement|SVGGElement|SVGGlyphElement|SVGFETileElement|SVGGradientElement|SVGLinearGradientElement|SVGRadialGradientElement|SVGImageElement|SVGFontFaceNameElement|SVGHKernElement|SVGGlyphRefElement|SVGMPathElement|SVGMarkerElement|SVGMaskElement|SVGLineElement|SVGMetadataElement|SVGMissingGlyphElement|SVGPathElement|SVGFEMergeNodeElement|SVGPatternElement|SVGPolygonElement|SVGPolylineElement|SVGRectElement|SVGScriptElement|SVGStopElement|SVGStyleElement|SVGSVGElement|SVGSwitchElement|SVGSymbolElement|SVGTitleElement|SVGUseElement|SVGVKernElement|SVGViewElement"].join("|"), v5_UIEvent = [v0_MouseEvent, "UIEvent|TextEvent|TouchEvent|CompositionEvent|SVGZoomEvent|KeyboardEvent"].join("|"), v6_Element = [v3_MediaElement, v4_SvgElement, "Element|HTMLQuoteElement|HTMLScriptElement|HTMLSelectElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTextAreaElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement|HTMLAppletElement|HTMLBaseFontElement|HTMLDirectoryElement|HTMLFontElement|HTMLFrameElement|HTMLFrameSetElement|HTMLMarqueeElement|HTMLAnchorElement|HTMLAreaElement|HTMLBRElement|HTMLBaseElement|HTMLBodyElement|HTMLButtonElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLElement|HTMLDivElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFormElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLIFrameElement|HTMLImageElement|HTMLInputElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMenuElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPreElement|HTMLProgressElement"].join("|"), v7_DocumentFragment = "DocumentFragment|ShadowRoot", v8_CharacterData = "CharacterData|Text|CDATASection|Comment", v9_Document = "Document|SVGDocument|HTMLDocument", v10_Node = [v6_Element, v7_DocumentFragment, v8_CharacterData, v9_Document, "Node|Attr|DocumentType|EntityReference|Notation|ProcessingInstruction"].join("|"), v11_MediaStream = "MediaStream|LocalMediaStream";
  $.dynamicSetMetadata([["SVGComponentTransferFunctionElement", v2_ComponentTransferFunctionElement], ["Blob", "Blob|File"], ["CharacterData", v8_CharacterData], ["CSSRule", "CSSRule|CSSUnknownRule|CSSStyleRule|CSSPageRule|CSSFontFaceRule|WebKitCSSKeyframesRule|CSSMediaRule|CSSCharsetRule|WebKitCSSKeyframeRule|CSSImportRule"], ["StyleSheet", "StyleSheet|CSSStyleSheet"], ["Document", v9_Document], ["DocumentFragment", v7_DocumentFragment], ["MouseEvent", v0_MouseEvent], ["UIEvent", v5_UIEvent], ["Uint8Array", "Uint8Array|Uint8ClampedArray"], ["HTMLMediaElement", v3_MediaElement], ["SVGTextPositioningElement", v1_TextPositioningElement], ["SVGElement", v4_SvgElement], ["Element", v6_Element], ["Entry", "Entry|DirectoryEntry|FileEntry"], ["EntrySync", "EntrySync|FileEntrySync|DirectoryEntrySync"], ["Event", [v5_UIEvent, "Event|ProgressEvent|XMLHttpRequestProgressEvent|RTCDataChannelEvent|RTCIceCandidateEvent|SpeechInputEvent|SpeechRecognitionError|SpeechRecognitionEvent|StorageEvent|TrackEvent|WebKitTransitionEvent|WebGLContextEvent|IDBVersionChangeEvent|IDBVersionChangeEvent|DeviceMotionEvent|BeforeLoadEvent|CloseEvent|DeviceOrientationEvent|CustomEvent|ErrorEvent|WebKitAnimationEvent|HashChangeEvent|AudioProcessingEvent|OfflineAudioCompletionEvent|MediaKeyEvent|MediaStreamEvent|MediaStreamTrackEvent|MessageEvent|MutationEvent|OverflowEvent|PageTransitionEvent|PopStateEvent"].join("|")], ["Node", v10_Node], ["MediaStream", v11_MediaStream], ["EventTarget", [v10_Node, v11_MediaStream, "EventTarget|SourceBufferList|TextTrack|TextTrackCue|TextTrackList|DOMWindow|SVGElementInstance"].join("|")], ["CSSValueList", "CSSValueList|WebKitCSSFilterValue|WebKitCSSMixFunctionValue|WebKitCSSTransformValue"], ["HTMLCollection", "HTMLCollection|HTMLFormControlsCollection|HTMLOptionsCollection"], ["NodeList", "NodeList|RadioNodeList"]]);
})();
...
//@ sourceMappingURL=Controls_FirstPerson.dart.js.map